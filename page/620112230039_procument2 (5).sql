...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2022 at 07:36 AM
...
--
-- Database: `620112230039_procument2`
--
...
CREATE TABLE `agency` (
  ...
  `agctype_id` int(11) NOT NULL COMMENT 'รหัสประเภทหน่วยงาน',
  `agc_type` varchar(200) NOT NULL COMMENT 'ประเภทหน่วยงาน',
  `last_update_agc` date NOT NULL COMMENT 'อัพเดตล่าสุด'
...
INSERT INTO `agency` (`agc_id`, `agctype_id`, `agc_type`, `last_update_agc`) VALUES
(1, 1, 'สำนักส่งเสริมวิชาการและงานทะเบียน', '0000-00-00'),
(2, 2, 'สำนักวิทยบริการและเทคโนโลยีสารสนเทศ', '0000-00-00'),
(3, 3, 'สำนักประกันคุณภาพการศึกษาและตรวจสอบภายใน', '0000-00-00'),
(4, 4, 'สำนักศิลปะและวัฒนธรรม', '0000-00-00'),
(5, 5, 'สถาบันวิจัยและพัฒนา', '0000-00-00'),
(6, 6, 'สำนักงานอธิการบดี', '0000-00-00'),
(7, 7, 'สำนักงานต่างประเทศ', '0000-00-00'),
(8, 8, 'สำนักงานบริการทางวิชาการ', '0000-00-00'),
(9, 9, 'ศูนย์คอมพิวเตอร์และอินเทอร์เน็ต', '0000-00-00'),
(10, 10, 'ศูนย์วิทยบริการ', '0000-00-00'),
(11, 11, 'ศูนย์เทคโนโลยีการศึกษา', '0000-00-00'),
(12, 12, 'ศูนย์บ่มเพาะวิสาหกิจ', '0000-00-00'),
(13, 13, 'ศูนย์วิทยาศาสตร์ประยุกต์', '0000-00-00'),
(14, 14, 'กองการบริหารงานบุคคล', '0000-00-00'),
(15, 15, 'กองนโยบายและแผน', '0000-00-00'),
(16, 16, 'กองพัฒนานักศึกษา', '0000-00-00'),
(17, 17, 'กองอาคารสถานที่และบริการ', '0000-00-00'),
(18, 18, 'กองทุนเงินให้กู้ยืมเพื่อการศึกษา', '0000-00-00'),
(19, 19, 'งานธุรการ', '0000-00-00'),
(20, 20, 'งานพัสดุ', '0000-00-00'),
(21, 21, 'งานการเงิน', '0000-00-00'),
(22, 22, 'งานประชาสัมพันธ์', '0000-00-00'),
(23, 23, 'งานก่อสร้าง', '0000-00-00'),
(24, 24, 'งานอนุรักษ์พลังงาน', '0000-00-00'),
(25, 25, 'งานสวัสดิการ', '0000-00-00'),
(26, 26, 'งานอนามัย', '0000-00-00'),
(27, 27, 'งานยานพาหนะ', '0000-00-00'),
(28, 28, 'ฝ่ายทรัพย์สิน', '0000-00-00'),
(29, 29, 'โรงเรียนสาธิต', '0000-00-00'),
(30, 30, 'พนมพิมาน', '0000-00-00'),
(31, 31, 'สภามหาวิทยาลัย', '0000-00-00'),
(32, 32, 'สภาคณาจารย์และข้าราชการ', '0000-00-00'),
(33, 33, 'คณะครุศาสตร์', '0000-00-00'),
(34, 34, 'คณะเทคโนโลยีอุตสาหกรรม', '0000-00-00'),
(35, 35, 'คณะเทคโนโลยีการเกษตร', '0000-00-00'),
(36, 36, 'คณะมนุษยศาสตร์และสังคมศาสตร์', '0000-00-00'),
(37, 37, 'คณะวิทยาศาสตร์', '0000-00-00'),
(38, 38, 'คณะวิทยาการจัดการ', '0000-00-00'),
(39, 39, 'คณะพยาบาลศาสตร์', '0000-00-00'),
(40, 40, 'บัณฑิตวิทยาลัย', '0000-00-00'),
(41, 41, 'สาขาวิทยาการคอมพิวเตอร์', '0000-00-00'),
(42, 41, 'สาขาวิทยาการคอมพิวเตอร์', '0000-00-00'),
(43, 41, 'สาขาวิทยาการคอมพิวเตอร์', '0000-00-00'),
(44, 41, 'สาขาวิทยาการคอมพิวเตอร์', '0000-00-00'),
(45, 42, 'สาขาวิทยาการอาหาร', '2022-04-05'),
(46, 42, 'สาขาวิทยาการอาหาร', '2022-04-05');
...
CREATE TABLE `company` (
  ...
  `cp_name` varchar(200) NOT NULL COMMENT 'ชื่อบริษัท',
  `cp_provinces` varchar(200) NOT NULL COMMENT 'ที่อยู่(จังหวัด)',
  `cp_amphures` varchar(200) NOT NULL COMMENT 'ที่อยู่(อำเภอ)',
  `cp_districts` varchar(200) NOT NULL COMMENT 'ที่อยู่(ตำบล)',
  `cp_tel` int(10) NOT NULL COMMENT 'โทรศัพท์',
  `cp_fax` int(9) NOT NULL COMMENT 'แฟกซ์',
  `cp_list` varchar(200) NOT NULL COMMENT 'รายละเอียดการค้าของผู้ขาย',
  `cp_email` varchar(200) NOT NULL COMMENT 'email',
  `cp_address` varchar(200) NOT NULL COMMENT 'ที่อยู่(รายละเอียด)',
...
INSERT INTO `company` (`cp_id`, `cp_name`, `cp_provinces`, `cp_amphures`, `cp_districts`, `cp_tel`, `cp_fax`, `cp_list`, `cp_email`, `cp_address`, `zip_code`) VALUES
(1, 'ใบหม่อนการค้า', 'สุรินทร์', 'สำโรงทาบ', '0', 12365478, 1236547, 'ขายของทั่วไป', 'mmm@gmail.com', 'บ้านหนองงูเหลือม', 32172),
(2, 'ฟางการค้า', '18', '207', '270201', 1236547899, 3265987, 'ขายสินค้าทั่วไป', 'fang@gmail.com', 'บ้านหัวถนน', 27260),
(3, 'ฟางการค้า', '16', '189', '250113', 1236547899, 3265987, 'ขายสินค้าทั่วไป', 'fang@gmail.com', 'บ้านหัวถนน', 25000),
(4, 'ฟางการค้า', '13', '162', '220313', 1236547899, 3265987, 'ขายสินค้าทั่วไป', 'fang@gmail.com', 'บ้านหัวถนน', 22120),
(5, 'ฟางการค้า233', '17', '203', '260207', 2147483647, 3265987, 'jmjlrkl;joetnl', 'fang@gmail.com', 'sdghsdhwse', 26130),
(6, 'hgn', '64', '865', '810201', 0, 0, 'nbmgb', 'hgnhg@gmail.com', 'hngb', 81140);
...
CREATE TABLE `disbursement` (
  `db_id` int(11) NOT NULL COMMENT 'รหัสเบิกจ่ายครุภัณฑ์',
  `db_agc_id` int(11) NOT NULL COMMENT 'รหัสหน่วยงาน',
  `db_eq_number` varchar(200) NOT NULL COMMENT 'หมายเลขครุภัณฑ์',
  `db_eq_list` text NOT NULL COMMENT 'รายการครุภัณฑ์',
  `db_amount` int(11) NOT NULL COMMENT 'จำนวนครุภัณฑ์',
  `db_ st_id` varchar(200) NOT NULL COMMENT 'สถานะ',
  `db_type_eq_id` varchar(200) NOT NULL COMMENT 'ประเภทครุภัณฑ์',
  `db_date` date NOT NULL COMMENT 'วันที่รับ',
  `db_contract_num` int(200) NOT NULL COMMENT 'เลขที่สัญญา',
  `db_cp_id` int(200) NOT NULL COMMENT 'ผู้ขาย(บริษัท,ห้าง,ร้าน)',
  `db_location` varchar(200) NOT NULL COMMENT 'สถานที่ใช้งาน',
  `db_mon_id` varchar(200) NOT NULL COMMENT 'งบที่ใช้',
  `db_price` int(50) NOT NULL COMMENT 'ราคา',
  `db_note` text NOT NULL COMMENT 'หมายเหตุ',
  `db_title_id` varchar(200) NOT NULL COMMENT 'คำนำหน้า',
  `db_fname` varchar(200) NOT NULL COMMENT 'ชื่อจริง',
  `db_lname` varchar(200) NOT NULL COMMENT 'นามสกุล',
  `db_per_userlevel` varchar(200) NOT NULL COMMENT 'ระดับบุคคล',
  `db_generation` text NOT NULL COMMENT 'ขนาดและลักษณะ',
  `db_unit` varchar(200) NOT NULL COMMENT 'หน่วยนับ',
  `db_fo_study` varchar(200) NOT NULL COMMENT 'สาขา',
...
INSERT INTO `disbursement` (`db_id`, `db_agc_id`, `db_eq_number`, `db_eq_list`, `db_amount`, `db_ st_id`, `db_type_eq_id`, `db_date`, `db_contract_num`, `db_cp_id`, `db_location`, `db_mon_id`, `db_price`, `db_note`, `db_title_id`, `db_fname`, `db_lname`, `db_per_userlevel`, `db_generation`, `db_unit`, `db_fo_study`, `db_status`) VALUES
(21, 6, 'pp/852', '19', 1, 'พร้อมใช้งาน', '1', '2022-04-29', 44, 0, 'อาคาร12', 'งบรายได้', 25830, '--', 'นางสาว', 'พิมพ์ลภัส1', 'ยอดไฟอินทร์', 'เจ้าหน้าที่', '--', 'ตัว', 'วิทยาศาสตร์สิ่งแวดล้อม(วท.บ.)', 1),
(22, 17, 'nm', '329', 235, 'ไม่พร้อมใช้งาน', '6', '2022-03-30', 44, 0, 'ดเ้ื่ทก้ดเ', 'งบแผ่นดิน', 424, '4252', 'นาย', 'c', 'gn', 'หน่วยงาน', '่าเ้ก่า้่าส', 'เครื่อง', 'สถิติประยุกต์(วท.บ.)', 1);
...
CREATE TABLE `equipment` (
  ...
  `eq_list` text NOT NULL COMMENT 'รายการหมวดหมู่ย่อยครุภัณฑ์',
  `eq_type_eq_id` varchar(200) NOT NULL COMMENT 'รหัสประเภทครุภัณฑ์  ',
  `eq_generation` varchar(200) NOT NULL COMMENT 'ขนาด/ลักษณะ',
  `eq_date` date NOT NULL COMMENT 'วันเดือนปีที่ซื้อ',
  `eq_location` varchar(200) NOT NULL COMMENT 'สถานที่ตั้ง  ',
  `eq_agc_id` varchar(200) NOT NULL COMMENT 'รหัสหน่วยงาน ',
  ` eq_mon_id` varchar(200) NOT NULL COMMENT 'รหัสประเภทเงิน',
  `eq_unit` varchar(200) NOT NULL COMMENT 'หน่วยนับ',
  `eq_price` double NOT NULL COMMENT 'ราคาต่อหน่วย',
  `eq_st_id` varchar(200) NOT NULL COMMENT 'สถานะครุภัณฑ์',
  `eq_note` text NOT NULL COMMENT 'หมายเหตุ',
  `eq_cp` varchar(200) NOT NULL COMMENT 'บริษัท/ห้าง/ร้าน',
  `eq_fo_study` varchar(200) NOT NULL COMMENT 'สาขา'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `equipment` (`eq_id`, `eq_number`, `eq_list`, `eq_type_eq_id`, `eq_generation`, `eq_date`, `eq_location`, `eq_agc_id`, ` eq_mon_id`, `eq_unit`, `eq_price`, `eq_st_id`, `eq_note`, `eq_cp`, `eq_fo_study`) VALUES
(15, '6666', '91', '1', '666', '0000-00-00', 'อาคาร3', 'ศูนย์วิทยาศาสตร์ประยุกต์', 'งบรายได้', 'เครื่อง', 6666, 'ชำรุด', '6666', '666', ''),
(16, '123456/2560', '84', '1', 'หนัก 250 กก', '0000-00-00', 'อาคาร5', '37', 'งบรายได้', 'เครื่อง', 20000, 'พร้อมใช้งาน', '-', 'ร้านเครื่องพิมพ์', 'สถาปัตยกรรม(วท.บ.)'),
(18, '123/5698', '19', '1', 'ไม่มี', '2022-06-02', 'อาคาร5', 'สำนักส่งเสริมวิชาการและงานทะเบียน', 'งบรายได้', 'ตัว', 1000, 'พร้อมใช้งาน', 'ไม่มี', 'ร้านค้า', 'ภาษาอังกฤษ(ค.บ.)'),
(19, '3333333333333', '262', '5', '-----', '2022-04-07', 'อาคาร3', 'ศูนย์วิทยาศาสตร์ประยุกต์', 'งบรายได้', 'เครื่อง', 500, 'พร้อมใช้งาน', '--------', '--------', '');

-- --------------------------------------------------------

--
-- Table structure for table `fo_study`
--

CREATE TABLE `fo_study` (
  `id_fo` int(11) NOT NULL COMMENT 'field of study',
  `fo_name` varchar(200) CHARACTER SET utf8 NOT NULL COMMENT 'ชื่อสาขา',
  `fo_agc_id` int(200) NOT NULL COMMENT 'รหัสประเภทหน่วยงาน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `fo_study`
--

INSERT INTO `fo_study` (`id_fo`, `fo_name`, `fo_agc_id`) VALUES
(1, 'ภาษาอังกฤษ(ค.บ.)', 33),
(2, 'ดนตรีศึกษา(ค.บ.)', 33),
(3, 'คณิตศาสตร์(ค.บ.)	', 33),
(4, 'นาฏศิลป์(ค.บ.)', 33),
...
(8, 'สังคมศึกษา(ค.บ.) ', 33),
(9, 'ฟิสิกส์(ค.บ.)', 33),
(10, 'วิทยาศาสตร์(ค.บ.)', 33),
(11, 'การศึกษาปฐมวัย(ค.บ.)', 33),
(12, 'เทคโนโลยีและคอมพิวเตอร์เพื่อการศึกษา(ค.บ.)', 33),
(13, 'ภูมิสารสนเทศ(วท.บ.)', 37),
(14, 'เคมี(วท.บ.)', 37),
(15, 'วิทยาศาสตร์สิ่งแวดล้อม(วท.บ.)', 37),
(16, 'สาธารณสุขชุมชน(วท.บ.)', 37),
(17, 'สถิติประยุกต์(วท.บ.)', 37),
(18, 'ชีววิทยา(วท.บ.)', 37),
(19, 'เทคโนโลยีสารสนเทศ(วท.บ.)', 37),
(20, 'วิทยาการคอมพิวเตอร์(วท.บ.)', 37),
(21, 'คณิตศาสตร์(วท.บ.)', 37),
(22, 'วิทยาศาสตร์การกีฬา(วท.บ.)', 37),
(23, 'วิทยาศาสตร์สิ่งทอ(วท.บ.)', 37),
(24, 'วิทยาศาสตร์การอาหาร(วท.บ.)', 37),
(25, 'เกษตรศาสตร์(วท.บ.)', 35),
(26, 'ประมง(วท.บ.)', 35),
(27, 'สัตวศาสตร์(วท.บ.)', 35),
(28, 'การบัญชี(บช.บ.)', 38),
(29, 'การสื่อสารมวลชน(นศ.บ.)', 38),
(30, 'การท่องเที่ยวและการโรงแรม(ศศ.บ.)', 38),
(31, 'เศรษฐศาสตร์(ศ.บ.)', 38),
(32, 'การเงินและการธนาคาร(บธ.บ.)', 38),
(33, 'การจัดการ(บธ.บ.)', 38),
(34, 'การตลาด(บธ.บ.)', 38),
(35, 'การบริหารทรัพยากรมนุษย์(บธ.บ.)', 38),
(36, 'คอมพิวเตอร์ธุรกิจ(บธ.บ.)', 38),
(37, 'การพัฒนาสังคม(ศศ.บ.)', 36),
(38, 'ภาษาไทย(ศศ.บ.)', 36),
(39, 'บรรณารักษ์ศาสตร์และสารสนเทศศาสตร์(ศศ.บ.)', 36),
(40, 'ภาษาอังกฤษ(ศศ.บ.)', 36),
(41, 'ภาษาอังกฤษธุรกิจ(ศศ.บ.)', 36),
(42, 'ดนตรีสากล(ศศ.บ.)', 36),
(43, 'คอมพิวเตอร์ศิลปะและการออกแบบ(ศศ.บ.)', 36),
(44, 'รัฐประศาสนศาสตร์(รป.บ.)', 36),
(45, 'นิติศาสตร์(น.บ.)', 36),
(46, 'สถาปัตยกรรม(วท.บ.)', 34),
(47, 'เทคโนโลยีการจัดการอุตสาหกรรม(วท.บ.)', 34),
(48, 'เทคโนโลยีก่อสร้าง(วท.บ.)', 34),
(49, 'เทคโนโลยีวิศวกรรมไฟฟ้า(วท.บ.)', 34),
(50, 'เทคโนโลยีเซรามิกส์(วท.บ.)', 34),
(51, 'อิเล็กทรอกนิกส์สื่อสาร(วท.บ.)', 34),
(52, 'การออกแบบผลิตภัณฑ์อุตสาหกรรม(วท.บ.)', 34),
(53, 'พยาบาลศาสตร์', 39);
...
CREATE TABLE `money_type` (
  ...
  `mon_type` varchar(200) NOT NULL COMMENT 'ประเภทเงิน',
...
INSERT INTO `money_type` (`mon_id`, `mon_type`, `last_update`) VALUES
(1, 'งบรายได้', '0000-00-00'),
...
CREATE TABLE `personnel` (
  `per_id` int(11) NOT NULL COMMENT 'รหัสบุคลากร',
  `per_title` varchar(200) NOT NULL COMMENT 'คำนำหน้าชื่อ',
  `per_fname` varchar(200) NOT NULL COMMENT 'ชื่อจริง',
  `per_lname` varchar(11) NOT NULL COMMENT 'นามสกุล',
  `per_gender` varchar(200) NOT NULL COMMENT 'เพศ',
  `per_idcard` int(13) NOT NULL COMMENT 'เลขรหัสประจำตัวประชาชน',
  `per_birthday` date NOT NULL COMMENT 'วันเกิด',
  `per_address` varchar(200) NOT NULL COMMENT 'ที่อยู่',
  `per_provinces` varchar(200) NOT NULL COMMENT 'ที่อยู่(จังหวัด)',
  `per_amphures` varchar(200) NOT NULL COMMENT 'ที่อยู่(อำเภอ)',
  `per_districts` varchar(200) NOT NULL COMMENT 'ที่อยู่(ตำบล)',
  `per_tel` varchar(10) NOT NULL COMMENT 'หมายเลขโทรศัพท์',
  `per_email` varchar(50) NOT NULL COMMENT 'อีเมล',
  `per_user` varchar(50) NOT NULL COMMENT 'ชื่อเข้าใช้งาน',
  `per_pass` varchar(50) NOT NULL COMMENT 'รหัสเข้าใช้งาน',
  `per_userlevel` varchar(200) NOT NULL COMMENT 'สถานะผู้ใช้งาน',
  `zip_code` varchar(200) NOT NULL COMMENT 'ไปรษณีย์',
  `per_image` varchar(255) NOT NULL,
  `per_userlevel_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `personnel` (`per_id`, `per_title`, `per_fname`, `per_lname`, `per_gender`, `per_idcard`, `per_birthday`, `per_address`, `per_provinces`, `per_amphures`, `per_districts`, `per_tel`, `per_email`, `per_user`, `per_pass`, `per_userlevel`, `zip_code`, `per_image`, `per_userlevel_id`) VALUES
(83, 'ดร.', 'ฟางงงง22', 'ยสดวส', '2', 2147483647, '2022-04-20', 'แ้ิกดอแหผเะหำกเ', '16', '199', '251107', '0232123123', 'fang@gamil.com', '1234', '81dc9bdb52d04dc20036dbd8313ed055', 'เจ้าหน้าที่', '   0', '99.webp', 0),
(84, 'ผศ.ดร.', 'ฟางงงง22', 'ยสดวส', 'หญิง', 2147483647, '2022-04-02', '่ดเ้่ดเ', '17', '204', '260303', '22222222', 'fang02554@gamil.com', '0123', '2c71e977eccffb1cfb7c6cc22e0e7595', 'เจ้าหน้าที่', '   26110', '63.jpg', 0),
(85, 'ดร.', 'ฟางงงง22', 'ยสดวส', '2', 2147483647, '2022-04-20', 'แ้ิกดอแหผเะหำกเ', '16', '199', '251107', '0232123123', 'fang@gamil.com', '0123', '2c71e977eccffb1cfb7c6cc22e0e7595', 'เจ้าหน้าที่', '   0', '99.webp', 0);
...
--
-- Table structure for table `stab_distributor`
--

CREATE TABLE `stab_distributor` (
  `sd_id` int(11) NOT NULL COMMENT 'รหัสแทงจำหน่าย',
  `eq_id` varchar(200) NOT NULL COMMENT 'รหัส\r\nรหัสหมายเลขครุภัณฑ์',
  `eq_list` text NOT NULL COMMENT 'รายการครุภัณฑ์',
  `agc_id` int(11) NOT NULL COMMENT 'รหัสหน่วยงานที่ใช้งาน',
  `eq_amount` int(11) NOT NULL COMMENT 'จำนวนครุภัณฑ์',
  `eq_unitprice` double NOT NULL COMMENT 'ราคาต่อหน่วย',
  `eq_date` date NOT NULL COMMENT 'วันเดือนปีที่ซื้อ',
  `fiscal_year` year(4) NOT NULL COMMENT 'ปีงบประมาณ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `stab_distributor`
--

INSERT INTO `stab_distributor` (`sd_id`, `eq_id`, `eq_list`, `agc_id`, `eq_amount`, `eq_unitprice`, `eq_date`, `fiscal_year`) VALUES
(1, '0', 'โต็ะ', 1, 2, 0.25, '2022-04-13', 0000),
(2, '13.01.0245/62', 'ครุภัณฑ์วัด', 1, 2, 0.25, '2022-04-13', 0000);

-- --------------------------------------------------------

--
-- Table structure for table `status_dis`
--

CREATE TABLE `status_dis` (
  `std_id` int(11) NOT NULL,
  `std_name` varchar(200) NOT NULL COMMENT 'สถานะเบิกจ่าย'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Table structure for table `status_eq`
--

CREATE TABLE `status_eq` (
  `st_id` int(10) NOT NULL,
  `st_name` varchar(200) NOT NULL COMMENT 'ชื่อสถานะ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `status_eq`
--

INSERT INTO `status_eq` (`st_id`, `st_name`) VALUES
(1, 'พร้อมใช้งาน'),
(2, 'ไม่พร้อมใช้งาน'),
(3, 'ชำรุด');
...
--
-- Table structure for table `subcategory_eq`
--

CREATE TABLE `subcategory_eq` (
...
--
-- Dumping data for table `subcategory_eq`
--

INSERT INTO `subcategory_eq` (`sub_id`, `sub_name`, `sub_eq_code`, `sub_age`) VALUES
(1, 'เก้าอี้', 1, ''),
(2, 'โต๊ะ', 1, ''),
(3, 'ม้านั่ง\r\n', 1, ''),
(4, 'ตู้ดรรชนี', 1, ''),
...
(9, 'เครื่องดูดฝุ่น', 1, ''),
(10, 'เครื่องขัดพิ้น', 1, ''),
(11, 'เครื่องคำนวณ(เครื่องคิดเลข)', 1, ''),
(12, 'เครื่องบวกเลข', 1, ''),
(13, 'เครื่องชุมสายโทรศัพท์', 1, ''),
(14, 'ตู้โทรศัพท์', 1, ''),
(15, 'เครื่องโทรศัพท์', 1, ''),
(16, 'เครื่องโทรพิมพ์(โทรสาร)', 1, ''),
(17, 'เครื่องพิมพ์ดีด', 1, ''),
(18, 'เครื่องอัดสำเนา(เครื่องโรเนียว)', 1, ''),
(19, 'เครื่องถ่ายเอกสาร', 1, ''),
(20, 'เครื่องปรุกระดาษไข', 1, ''),
(21, 'เครื่องปรับอากาศ', 1, ''),
(22, 'เครื่องรับเงิน/เครื่องบัยทึกเงิน', 1, ''),
(23, 'กำปั่นเก็บเงิน', 1, ''),
(24, 'หีบเหล็กเก็บเงิน', 1, ''),
(25, 'ชุดรับเเขก', 1, ''),
(26, 'เคาน์เตอร์\r\n', 1, ''),
(27, 'มู่ลี่/ผ้าม่าน', 1, ''),
(28, 'พรม', 1, ''),
(29, 'นาฬิกา', 1, ''),
(30, 'เเท่นอ่านหนังสือ,เเท่นวางโทรศัพท์', 1, ''),
(31, 'ผังเเสดงวงจรต่างๆ', 1, ''),
(32, 'เเผงบังคับทางไฟ', 1, ''),
(33, 'พัดลม', 1, ''),
(34, 'ไฟฉายสปอทไลท์ขนาดเกินกว่า 500 เเรงเทียนขึ้นไป', 1, ''),
(35, 'รถเข็น', 1, ''),
(36, 'ถังเหล็กบรรจุน้ำ', 1, ''),
(37, 'พระพุทธรูป,พระบรมรูปจำลอง', 1, ''),
(38, 'ตราพระราชลัญจกร', 1, ''),
(39, 'เครื่องจับเวลา', 1, ''),
(40, 'เครื่องชั่ง', 1, ''),
(41, 'เครื่องพืมสำเนาระบบดิจิตอล', 1, ''),
(42, 'ตู้ลำโพง', 1, ''),
(43, 'ตู้ชั้นวางของ', 1, ''),
(44, 'เครื่องเพรทกระดาษ/เครื่องพับกระดาษ', 1, ''),
(45, 'นั่งร้านเหล็ก/เวที', 1, ''),
(46, 'เครื่องปั๊มเลขเช็ค', 1, ''),
(47, 'เครื่องตัดกระดาษ', 1, ''),
(48, 'ตู้ใล่สไลด์', 1, ''),
(49, 'โต๊ะหมูบูชา', 1, ''),
(50, 'ป้ายต่างๆ', 1, ''),
(51, 'กระดานดำ(บอร์ด)ฉากกั้นห้อง', 1, ''),
(52, 'เครื่องเย็บกระดาษไฟฟ้า', 1, ''),
(53, 'เครื่องดับเพลิง', 1, ''),
(54, 'เครื่องมือเขียนรายละเอียดตัวอักษร ตัวเลขเเละสัฯญลักษณ์/ปากกาอิเล็คทรอนิกส์', 1, ''),
(55, 'เครื่องถ่ายแผ่นโปร่งใส', 1, ''),
(56, 'แผ่นอัดสำเนา', 1, ''),
(57, 'เครื่องพิมพ์คอมพิวเตอร์', 1, ''),
(58, 'เครื่องขับแผ่นจานแม่เหล็ก', 1, ''),
(59, 'เครื่องตอกตาไก่', 1, ''),
(60, 'เครื่องฉายไมโครฟิล์ม', 1, ''),
(61, 'เครื่องย่อกระดาษ', 1, ''),
(62, 'ผนึกพลาสติก(เครื่องเคลือบบัตร)', 1, ''),
(63, 'เครื่องพิมพ์ออฟเซท', 1, ''),
(64, 'เครื่องไมโครคอมพิวเตอร์(คอมพิวเตอร์,จอ,หน่วยความจำ)', 1, ''),
(65, 'เครื่องทำลายเอกสาร', 1, ''),
(66, 'เครื่องตอกตัวเลข', 1, ''),
(67, 'ที่งัดลวดเย็บขนาดใหญ่', 1, ''),
(68, 'เครื่องเจาะเข้าเล่ม', 1, ''),
(69, 'เครื่องพิมพ์ EPSON', 1, ''),
(70, 'เครื่องควบคุมกระแสไฟฟ้า', 1, ''),
(71, 'โต๊ะวางเครื่องคอมพิวเตอร์', 1, ''),
(72, 'โต๊ะวางเครื่องพิมพ์', 1, ''),
(73, 'อุปกรณ์การพิมพ์ประกอบชุดไมโครคอมพิวเตอร์', 1, ''),
(74, 'เครื่องโมเดม', 1, ''),
(75, 'เครื่องดิคชั่นรี่(Dictionary)', 1, ''),
(76, 'แสตน(แท่นบรรยาย)', 1, ''),
(77, 'เครื่องตรวจข้อสอบ', 1, ''),
(78, 'อุปกรณ์เชื่อมต่อเครือข่าย Hub', 1, ''),
(79, 'โปรแกรมคอมพิวเตอร์', 1, ''),
(80, 'เครื่องฉายภาพคอมพิวเตอร์', 1, ''),
(81, 'โปรแกรมห้องสมุด', 1, ''),
(82, 'เครื่องทำตรายาง', 1, ''),
(83, 'เครื่องเรียงข้อสอบ', 1, ''),
(84, 'เครื่องพิมพ์รหัสเเท่ง', 1, ''),
(85, 'เคริ่องอ่านบาร์โค๊ดมือถือ/เครื่องควบคุมการเข้า-ออก', 1, ''),
(86, 'เครื่องสัญญาณกันโขมย(เครื่องตรวจเช็คหนังสือทางเข้าออก)', 1, ''),
(87, 'เครื่องอัดหนังสือ', 1, ''),
(88, 'เคึรื่องฟอกอากาศ', 1, ''),
(89, 'เครื่องสร้างหมอก', 1, ''),
(90, 'ตราดุน(พร้อมแท่น)', 1, ''),
(91, 'ปืนยิงลูกเม็ด', 1, ''),
(92, 'เกจวัดเเรงดัน(แอร์)', 1, ''),
(93, 'ชุดล้างท่อน้ำยาแอร์', 1, ''),
(94, 'เครื่องจัดระบบบัตรคิว', 1, ''),
(95, 'รถยนต์นั่ง,เก๋ง,ตู้', 2, ''),
(96, 'รถยนต์โดยสาร(บัส)', 2, ''),
(97, 'รถยกของ', 2, ''),
(98, 'รถปั้นจั่น', 2, ''),
(99, 'รถบรรทุก(ปิคอัพ)', 2, ''),
(100, 'รถลากเครื่องบิน', 2, ''),
(101, 'รถเทลเลอร์', 2, ''),
(102, 'รถดับเพลิง', 2, ''),
(103, 'รถเข็น', 2, ''),
(104, 'รถจักรยานยนต์', 2, ''),
...
(108, 'เรือติดท้าย', 2, ''),
(109, 'เรือเร็ว', 2, ''),
(110, 'เรือพ่วง(รถพ่วง)', 2, ''),
(111, 'เครื่องบิน', 2, ''),
(112, 'รถยนต์สองแถวโดยสาร', 2, ''),
(113, 'รถยนต์เกษตร,รถบรรทุกน้ำ', 2, ''),
(114, 'เครื่องยนต์', 2, ''),
(115, 'รถสามล้อถีบส่งของ', 2, ''),
(116, 'รถโรยเส้นสนามกีฬา', 2, ''),
(117, 'ชุดระบบห้ามล้อ', 2, ''),
(118, 'เรือไฟเบอร์', 2, ''),
(119, 'ถุงลม', 2, ''),
(120, 'สัญญาณไฟฉุกเฉิน', 2, ''),
(121, 'รถไฟฟ้า', 2, ''),
(122, 'รถจักรยานยนต์ไฟฟ้า', 2, ''),
(124, 'ปศุสัตว์', 3, ''),
(125, 'รถไถ', 2, ''),
(126, 'รถแทรกเตอร์ ', 3, ''),
(127, 'จอบหมุน', 3, ''),
(128, 'จานพรวน', 3, ''),
(129, 'ผานไถกะทะ', 3, ''),
(130, 'เครื่องตัดข้าวโพด ข้าวฟ่าง', 3, ''),
(131, 'เครื่องตัดวัชพืช', 3, ''),
(132, 'เครื่องหว่านปุ๋ย', 3, ''),
(133, 'เครื่องหยอดหรือหว่านเมล็ดพันธ์', 3, ''),
(134, 'เครื่องทำความสะอาดเมล็ดพันธ์', 3, ''),
(135, 'เครื่องกระเทาะเมล็ดพืช', 3, ''),
(136, 'เครื่องยกร่อง', 3, ''),
(137, 'เครื่องนวดธัญพืช/เครื่องนวดข้าว', 3, ''),
(138, 'เครื่องผสมยาคลุกเมล็ดพันธ์', 3, ''),
(139, 'เครื่องนับเมล็ดพืช', 3, ''),
(140, 'คราดซี่พรวนดินระหว่างเเถว', 3, ''),
(141, 'ตู้เก็บเมล็ดพันธ์', 2, ''),
(142, 'เครื่องรถน้ำ', 3, ''),
(143, 'เครื่องสีข้าวโพด/สีข้าว', 3, ''),
(144, 'เครื่องสีฝัด', 3, ''),
(145, 'เครื่องเกลี่ยหญ้า', 3, ''),
(146, 'เครื่องคราดหญ้า', 3, ''),
(147, 'เครื่องดักแมลง', 3, ''),
(148, 'เครื่องบดเเละผสมอาหารสัตว์/เครื่องอัดเม็ดอาหารปลา', 3, ''),
(149, 'เครื่องพ่นยา', 3, ''),
(150, 'เครื่องสูบน้ำ/เครื่องปั้มน้ำ', 3, ''),
(151, 'ระหัด', 3, ''),
(152, 'เครื่องขยายเกล็ดปลา', 3, ''),
(153, 'ตะเเกรงร่อนเบนโธส', 3, ''),
(154, 'อวน', 3, ''),
(155, 'เครื่องสับผสม', 3, ''),
(156, 'เครื่องวัดความหวานผลไม้', 3, ''),
(157, 'เครื่องวัดการเจริญเติบโตของพืช/วัดความสูงพืช/เครื่องวัดส่วนต่างของพืช', 3, ''),
(158, 'เครื่องตัวเนื้อเยื่อด้วยมือ', 3, ''),
(159, 'เครื่องรีดน้ำเชื่อโค/รีดนม', 3, ''),
(160, 'อุปกรณ์ผสมเทียม', 3, ''),
(161, 'เครื่องตรวจการตั้งท้องสุกร', 3, ''),
(162, 'เครื่องตรวจการเป็นสัดสุกร', 3, ''),
(163, 'กรรไกรตัดกระดูก', 3, ''),
(164, 'คีมตอนโค', 3, ''),
(165, 'เครื่องถอนขนไก่', 3, ''),
(166, 'เครื่องอัดฟาง', 3, ''),
(167, 'ตู้ฟักไข่', 3, ''),
(168, 'เครื่องตัดหญ้ารถไถ', 3, ''),
(169, 'เครื่องทำเครื่องหมายสัตว์', 3, ''),
(170, 'เครื่องวัดความนุ่มเนื้อ', 3, ''),
(171, 'เครื่องวัดอัตราการซึมน้ำในดิน', 3, ''),
(172, 'เครื่องทดสอบดิน/หม้อบดดิน', 3, ''),
(173, 'เครื่องเจาะเก็บตัวอย่างดิน', 3, ''),
(174, 'เครื่องวัดการปิดเปิดปากใบพืช', 3, ''),
(175, 'ถังเก็บน้ำเชื้อ', 3, ''),
(176, 'เครื่องวัดความชื้นชองเมล็ดพืช', 3, ''),
(177, 'ซองบังคับสัตว์', 3, ''),
(178, 'ชุดเทียบสีทางพืชสวน', 3, ''),
(179, 'เครื่องอบเมล็ดพันธ์พืช', 3, ''),
(180, 'เครื่องวิเคราะห์ตรวจสอบน้ำนม', 3, ''),
(181, 'เครื่องปิดปากถุงอัตโนมัติ', 3, ''),
(182, 'เครื่องวิเคราะห์เมล็ดพันธ์พืช', 3, ''),
(183, 'เครื่องบรรจุกระป๋อง', 3, ''),
(184, 'ถุงลากเเพลงตอน', 3, ''),
(185, 'เครื่องวิเคราะห์เยื่อใย', 3, ''),
(186, 'เครื่องวัดพื้นที่ของพืช', 3, ''),
(187, 'เครื่องสกัดแลกน้ำผลไม้/ชุดเครื่องสกัดน้ำสมุนไพร', 3, ''),
(188, 'เครื่องไล่อากาศ', 3, ''),
(189, 'เครื่องวัดศักยภาพของน้ำในใบพืช/เครื่องวัดคลอโรฟิลล์', 3, ''),
(190, 'เครื่องบรรจุของเหลวในถุงพลาสติก', 3, ''),
(191, 'เครื่องอัดถุงเห็ด', 3, ''),
(192, 'ชุดปลูกพืชในน้ำยา(ไฮโดรโฟนิก)', 3, ''),
(193, 'เครื่องกระทุ้งดินหรือแอสฟัสท์', 4, ''),
(194, 'เครื่องกลึง', 4, ''),
(195, 'เครื่องเจาะหิน', 4, ''),
(196, 'เครื่องเจาะเหล็ก/เครื่องกัดเหลา', 4, ''),
(197, 'สว่านเจาะเเผ่นเหล็ก', 4, ''),
(198, 'เครื่องเชื่อมโลหะ', 4, ''),
(199, 'เครื่องพ่นสี,เครื่องพ่นทราย,พู่กันกินลม/เครื่องพ่นไฟ', 4, ''),
(200, 'เครื่องผสมยางแอสฟัสท์', 4, ''),
(201, 'ีเครื่องผสมคอนกรีต', 4, ''),
(202, 'เครื่องมือทดสอบคอนกรีต', 4, ''),
(203, 'เครื่องสั่นคอนกรีต', 4, ''),
(204, 'เครื่องมือทดสอบความลาดเท', 4, ''),
(205, 'เครื่องมือแกะสลัก', 4, ''),
(206, 'เครื่องมือไสไม้ไฟฟ้า(กบไฟฟ้า)', 4, ''),
(207, 'เลื่อยไฟฟ้า', 4, ''),
(208, 'เครื่องมือดึงสายโทรศัพท์', 4, ''),
(209, 'ตอกแม่แรง', 4, ''),
(210, 'โซ่ลานพร้อมปอนด์ดึง', 4, ''),
(211, 'รถเตาต้มยาง\r\n', 4, ''),
(212, 'รถพ่นยาง', 4, ''),
(213, 'รถดักดิน', 4, ''),
(214, 'รถบด', 4, ''),
...
(217, 'รถอัดฉีด', 4, ''),
(218, 'รถบรรทุกน้ำ', 4, ''),
(219, 'รถบรรทุกน้ำมัน', 4, ''),
(220, 'รถกวาดถนน', 4, ''),
(221, 'รถเข็น', 4, ''),
(222, 'เครื่องโม่หิน', 4, ''),
(223, 'เครื่องตอกเข็ม', 4, ''),
(224, 'เครื่องตีเส้น', 4, ''),
(225, 'เครื่องอัดจารบี', 4, ''),
(226, 'เครื่องอัดลม(เป่าลม,ปั้มลม)', 4, ''),
(227, 'ไม้สค๊าฟ', 4, ''),
(228, 'บันได', 4, ''),
(229, 'เครื่องทดสอบการยุบตัวของคอนกรีต', 4, ''),
(230, 'เครื่องขัดกระดาษทราย', 4, ''),
(231, 'เครื่องมือตัดกระเบื้อง', 4, ''),
(232, 'เวอร์เนียร์', 4, ''),
(233, 'เครื่องทดสอบการอัดบดดิน', 4, ''),
(234, 'ค้อนทดสอบคอนกรีต', 4, ''),
(235, 'แบบหล่อคอนกรีต', 4, ''),
(236, 'นั่งร้านเหล็ก', 4, ''),
(237, 'หน้ากากปรับแสงอัตโนมัติ', 4, ''),
(238, 'เครื่องสกัดคอนกรีต', 4, ''),
(239, 'เครื่องทดสอบหาขนาดของเม็ดดิน', 4, ''),
(240, 'ชุดทดสอบหากำล้งต้านทางแรงเฉือนของดิน', 4, ''),
(241, 'ชุดทดสอบหาความทรุดตัวของดิน', 4, ''),
(242, 'ชุดทดสอบค่าความแข็งของวัตถุดิบ', 4, ''),
(243, 'ชุดทดสอบหาหน่วยน้ำของมวล', 4, ''),
(244, 'ชุดทดสอบการก่อตัวของซีเมนต์', 4, ''),
(245, 'ชุดทดสอบความถ่วงจำเพาะ', 4, ''),
(246, 'ชุดทดสอบการศึกกร่อนของหิน', 4, ''),
(247, 'ชุดทดสอบการไหลซึม', 4, ''),
(248, 'เครื่องยิงรีเวท', 4, ''),
(249, 'เร้าเตอร์(เครื่องเซาะร่อง)', 4, ''),
(250, 'ชุดปฎิบัติการช่างโลหะ', 4, ''),
(251, 'ชุดทดสอบความสมบูรณ์ของชิ้นงานก่อสร้าง', 4, ''),
(252, 'ชุดทดสอบไฮดรอลิค', 4, ''),
(253, 'ชุดทดสอบเครื่องมือสร้างความจำลองอากาศ', 4, ''),
(254, 'เครื่องกำเนิดไฟฟ้า', 5, ''),
(255, 'หม้อเเปลงไฟฟ้า/โซล่าเซล', 5, ''),
(256, 'เครื่องวัดเเรงดันไฟฟ้า(มอนิเตอร์)/เครื่องวัดค่าการนำไฟฟ้า', 5, ''),
(257, 'มาตรสำหรับตรวจวงจรไฟฟ้า/มัลติมิเตอร์ดิจิตอล', 5, ''),
(258, 'เครื่องประจุไฟฟ้า', 5, ''),
(259, 'เครื่องขยายเสียง/เครื่องเสียง/เครื่องขยายเสียงอเนกประสงค์', 5, ''),
(260, 'เครื่องบันทึกเสียง(เครื่องอัดเสียงสำเนาเทปเครื่องเล่น)', 5, ''),
(261, 'เครื่องเล่นเเผ่นเสียง(เครื่องเล่น CD,DVD,MP3)', 5, ''),
(262, 'เครื่องรับวิทยุ', 5, ''),
(263, 'เครื่องส่งวิทยุ,วิทยุสื่อสาร', 5, ''),
(264, 'เครื่องรับโทรทัศน์', 5, ''),
(265, 'เครื่องส่งโทรทัศน์', 5, ''),
(266, 'ไมโครโฟน', 5, ''),
(267, 'ลำโพง', 5, ''),
(268, 'เครื่องวัดความถี่คลื่น/เครื่องสร้างความถี่/ฟังชันก์เจนเนอร์เรเตอร์', 5, ''),
(269, 'โคมไฟฟ้าพร้อมเสา', 5, ''),
(270, 'โคมๆฟฟ้าติดโต๊ะ', 5, ''),
(271, 'โคมเขียนเเบบ', 5, ''),
(272, 'ขาตั้งไมโครโฟน', 5, ''),
(273, 'เครื่องโทรสาร', 5, ''),
(274, 'เครื่องเทปซิงโครไนซ์', 5, ''),
(275, 'โทรศัพท์มือถือ', 5, ''),
(276, 'เครื่องรับสัญญาณพร้อมจานดาวเทียม', 5, ''),
(277, 'เครื่องขยายสัญญาณ/เเยกสัญญาณ/สลับสัญญาณ', 5, ''),
(278, 'เครื่องควบคุมรั้วไฟฟ้า', 5, ''),
(279, 'ชุดประธานเเละผู้ร่วมประชุม', 5, ''),
(280, 'โปรเเกรมเมเบิลคอลโทรลเลอร์', 5, ''),
(281, 'ชุดสร้างเสียงดนตรี', 5, ''),
(282, 'เครื่องควบบคุมเวลาอัตโนมัติ/ชุดควบคุมอัตโนมัติงานอุตสาหกรรม', 5, ''),
(283, 'เครื่องชั่งสารไฟฟ้า', 5, ''),
(284, 'บูสเตอร์มิกเซอร์', 5, ''),
(285, 'เครื่องซีคอนเซอร์(ควบคุมสัญญาณเสียง)', 5, ''),
(286, 'เครื่องเเพทเทอนเย็นเนอร์เรเตส(จูลโทรทัศน์)', 5, ''),
(287, 'ชุดปฎิบัติการทางภาษา', 5, ''),
(288, 'ชุดทดลองวงจรอิเล็กทรอนิกส์', 5, ''),
(289, 'เเท่นชาร์จเเบตเตอรี่', 5, ''),
(290, 'เครื่องเเต่งเสียง/ปรีเเอมป์/ปรีไมค์', 5, ''),
(291, 'มอเตอร์ไฟฟ้า', 5, ''),
(292, 'อุปกรณ์ป้องกันฟ้าผ่า', 5, ''),
(293, 'ตู้คอลโทรลไฟฟ้า', 5, ''),
(294, 'เครื่องวัดสัญญาณไฟฟ้า(ออสสิโลสโคป)/เครื่องทือวัดอิเล็คทรอนนิกส์', 5, ''),
(295, 'เครื่องทดสอบระบบโทรศัทพ์', 5, ''),
(296, 'เครื่องควบคุมลำโพง', 5, ''),
(297, 'ตู้เเร็ค', 5, ''),
(298, 'เครื่องผสมเสียงสัญญาณเสียง(มิกเซอร์)', 5, ''),
(299, 'ชุดผลิตสื่อสารการสอนนอกสถานที่', 5, ''),
(300, 'เครื่องควบคุมไฟฟ้า(เบรกเกอร์)/รีโมท', 5, ''),
(301, 'ไม้ชักฟิว', 5, ''),
(302, 'ถุงมือกันไฟ', 5, ''),
(303, 'เข็มขัดขึ้นเสา', 5, ''),
(304, 'โต๊ะปฎิบัติการไฟฟ้า', 5, ''),
(305, 'ชุดฝึกปฎิบัติการขนส่งวัสดุ', 5, ''),
(306, 'ชุดฝึกปฎิบัติการจำลองของวิศวกรรม', 5, ''),
(307, 'เครื่องจับกระเเสไฟฟ้า', 5, ''),
(308, 'เครื่องทดสอบต้านทานไฟฟ้า(โฮห์ม)', 5, ''),
(309, 'ตัวโหลดนำไฟฟ้า', 5, ''),
(310, 'ชุดควบคุม LED', 5, ''),
(311, 'ปลั๊กรางจ่ายไฟ', 5, ''),
(312, 'กล้องถ่ายภาพนิ่ง', 6, ''),
(313, 'กล้องถ่ายภาพยนต์', 6, ''),
(314, 'เครื่องอัดเเลละขยายภาพ (เครื่องสำเนาเทปโทรทัศน์)', 6, ''),
(315, '้เครื่องฉายภาพนิ่ง', 6, ''),
(316, 'เครื่องถ่ายทอดสด', 6, ''),
(317, 'เครื่องฉายภาพยนตร์', 6, ''),
(318, 'จอภาพยนตร์/จอรับภาพ', 6, ''),
(319, 'เครื่องเล่น VDO', 6, ''),
(320, 'โต๊ะตัดต่อฟิล์มภาพยนตร์', 6, ''),
(321, 'เครื่องฉายภาพข้ามศรีษะ', 6, ''),
(322, 'เครื่องล้างหัวเทป', 6, ''),
(323, 'เลนส์มุมกล้อง', 6, ''),
(324, 'เครื่องถ่ายฟิล์ม', 6, ''),
(325, 'สไลด์,เครื่องฉายสไลด์', 6, ''),
(326, 'เครื่องควบคุมกล้อง', 6, ''),
(327, 'เครื่องบันทึกภาพโทรทัศน์ VDO, กล้องถ่าย VDO, กล้องวงจรปิด, กล้องโทรทัศน์', 6, ''),
(328, 'โปรเจคเตอร์', 6, ''),
(329, 'หูฟัง', 6, ''),
(330, 'เครื่องตรวจรรับสัญญาณภาพมอนิเตอร์', 6, ''),
(331, 'ขาตั้งกล้อง, ไฟ, โคมไฟ, อุปกรณ์กันสั่น', 6, ''),
(332, 'เครื่องตัดฟิล์ม(เครื่องตัด VDO),ชุดสื่อสารมวลชนสำหรับตัดต่อภาพ', 6, ''),
(333, 'โทรทัศน์', 6, ''),
(334, 'เครื่องทำสำเนา', 6, ''),
(335, 'ไฟเเวบ(เเฟล๊ต)', 6, ''),
(336, 'เครื่องพิมพ์ภาพสี', 6, ''),
(337, 'เตรื่องถ่ายภาพเข้าเครื่องคอมพิวเตอร์', 6, ''),
(338, 'ชุดผลิตสื่อนวัตกรรมนอกสถานที่,ชุดสื่อการเรียนการสอน', 6, ''),
(339, 'ชุดติดตั้งระบบภาพเเละเสียง', 6, ''),
(340, 'กล้องดูดาว,กล้องโทรทัศน์', 7, ''),
(341, 'กล้องจุลทรรศน์', 7, ''),
(342, 'เครื่องช่วยความสว่างของ-กล้องจุลทัศน์', 7, ''),
(343, 'เครื่องดูดควัน/ดูดความชื่น', 7, ''),
(344, 'เครื่องดูดอากาศ', 7, ''),
(345, 'เครื่องทดสอบความถ่วงจำเพาะของของเหลว', 7, ''),
(346, 'เครื่องมือเทียบสีเคมี/สเปคโตโฟมิเตอร์', 7, ''),
(347, 'เครื่องลอกลวดลายจากภาพถ่าย', 7, ''),
(348, 'เครื่องจ่ายเเก๊สคอลรีน', 7, ''),
(349, 'เครื่องเป่าลม/ชุดอนุรักษ์พลังงาน', 7, ''),
(350, 'เครื่องตรวจสอบมาตรไฟฟ้า', 7, ''),
(351, 'เครื่องมือเติมน้ำยา', 7, ''),
(352, 'เครื่องมือทดลองหาลอควิคลิมิท', 7, ''),
(353, 'เครื่องมือจับความเร็ว/เครื่องมือวัดความเร็วลม', 7, ''),
(354, 'เครื่องวัดกำลังอัด', 7, ''),
(355, 'เครื่องวัดความถี่/คลื่นความถี่สูง', 7, ''),
(356, 'เครื่องวัดความสูง', 7, ''),
(357, 'เครื่องชั่งน้ำหนัก', 7, ''),
(358, 'เครื่องอัดลมขับด้วยเครื่องยนต์', 7, ''),
(359, 'เครื่องกรองเเสง', 7, ''),
(360, 'เครื่องวัดเเสง/วัดคลื่น', 7, ''),
(361, 'เครื่องทดสอบเเสงสว่าง', 7, ''),
(362, 'เครื่องวัดรังสี/ชุดทดลองการแผ่รังสี', 7, ''),
(363, 'เครื่องวัดพลังงานแสงแดด', 7, ''),
(364, 'เครื่องวัดความกดอากาศ', 7, ''),
(365, 'เครื่องแปลสภาพน้ำกระด้างให้เป็นน้ำอ่อน/เครื่องทำน้ำปราศจากไอออน', 7, ''),
(366, 'เครื่องตรวจสอบคุณภาพน้ำ/เครื่องวัดค่าความนำไฟฟ้า', 7, ''),
(367, 'เครื่องกลั่นน้ำ', 7, ''),
(368, 'เครื่องกลั่นน้ำยา/กลั่นไนโตรเจน', 7, ''),
(369, 'เครื่องวัดอุณหภูมิน้ำ/เครื่องวัดอุณหภูมิ', 7, ''),
(370, 'เครื่องวัดน้ำฝน', 7, ''),
(371, 'เครื่องวัดความเป็นกรด-ด้าง', 7, ''),
(372, 'เครื่องระเหยของเหลว', 7, ''),
(373, 'เครื่องมือวิเคราะห์ด้วยเปลวไฟ/ชุดวิเคราะห์สารประกอบไนโตรเจน เครื่องมือวิเคราะห์โปรตีน', 7, ''),
(374, 'เครื่องวิเคราะแยกขนาดของเม็ดดิน/แยกสารต่างๆ(เครื่องฮิเลคนโตรโพรีซิส)', 7, ''),
(375, 'เครื่องวัดความชื้นในดิน', 7, ''),
(376, 'เครื่องกวนด้วยแม่เหล็ก', 7, ''),
(377, 'เครื่องนึ่ง(หม้อนึ่งอัดไอ)', 7, ''),
(378, 'ตู้เก็บเครื่องแก้ววิทยาศาสตร์', 7, ''),
(379, 'ตู้ทำน้ำแข็ง', 7, ''),
(380, 'หม้อต้มเครื่องมือ,สารเคมี', 7, ''),
(381, 'หม้อเก็บอากาศ', 7, ''),
(382, 'เตาแอลกอฮอล์', 7, ''),
(383, 'โซเดียมแลมพ์', 7, ''),
(384, 'เครื่องวัดความยืดและหดตัวของวัตถุ', 7, ''),
(385, 'เครื่องขบนิ่ง', 7, ''),
(386, 'เครื่องตักตะกอน/ปั่นตะกอน', 7, ''),
(387, 'เครื่องวัดตะกอน', 7, ''),
(388, 'เครื่องจี้จมูก', 7, ''),
(389, 'เครื่องจี้คอ', 7, ''),
(390, 'เครื่องเเคะเสมหะ', 7, '');
...
CREATE TABLE `tansfer` (
  `tr_id` int(11) NOT NULL COMMENT 'รหัสโอนย้ายครุภัณฑ์ ',
  `tr_slip_num` varchar(200) NOT NULL COMMENT 'เลขที่เอกสารการโอน\r\n',
  `tr_list` varchar(200) NOT NULL COMMENT 'รายการ\r\n',
  `tr_agc_id` varchar(200) NOT NULL COMMENT 'รหัสหน่วยงานเก่า',
  `tr_eq_number` varchar(200) NOT NULL COMMENT 'หมายเลขครุภัณฑ์ ',
  `tr_date` date NOT NULL COMMENT 'วันเดือนปีที่โอนย้าย ',
  `tr_agc` int(200) NOT NULL COMMENT 'รหัสหน่วยงานใหม่',
  `tr_location` text NOT NULL COMMENT 'ใช้ประจำ(ที่ใหม่)',
  `tr_note` text NOT NULL COMMENT 'หมายเหตุ',
  `unit_id` varchar(200) NOT NULL COMMENT 'หน่วยนับ',
  `amount` int(11) NOT NULL COMMENT 'จำนวน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tansfer`
--

INSERT INTO `tansfer` (`tr_id`, `tr_slip_num`, `tr_list`, `tr_agc_id`, `tr_eq_number`, `tr_date`, `tr_agc`, `tr_location`, `tr_note`, `unit_id`, `amount`) VALUES
(2, '', '', '12', '้่ม่าม', '2011-11-12', 1, 'มืทอสม่า', '้่ามส้่อม', '0', 0),
(3, '', '', '0', '', '0000-00-00', 0, '', '', '0', 0),
(4, '', '', '0', '', '0000-00-00', 0, '', '', '0', 0),
(5, '', '', '0', '', '0000-00-00', 0, '', '', '0', 0),
(6, '', '', '0', '', '0000-00-00', 0, '', '', '0', 0),
(7, '', '', '0', '', '0000-00-00', 0, '', '', '0', 0),
(8, '', '', '0', '', '0000-00-00', 0, '', '', '0', 0),
(9, '', 'โต๊ะ', '<br />\r\n<b>Warning</b>:  Undefined array key ', '13.01.0245/62', '2022-04-29', 0, 'าเ้้เ', 'ดเ้เด่', '0', 0),
(10, '', '', '<br />\r\n<b>Warning</b>:  Undefined array key ', '', '0000-00-00', 0, '', '', '0', 0),
(11, '', '', '<br />\r\n<b>Warning</b>:  Undefined array key ', '', '0000-00-00', 0, '', '', '0', 0),
(12, '', '', '<br />\r\n<b>Warning</b>:  Undefined array key ', '', '0000-00-00', 0, '', '', '0', 0),
(13, '', '', '<br />\r\n<b>Warning</b>:  Undefined array key ', '', '0000-00-00', 0, '', '', '0', 0),
(14, '', '', '<br />\r\n<b>Warning</b>:  Undefined array key ', '', '0000-00-00', 0, '', '', '0', 0),
...
CREATE TABLE `type_eq` (
  `type_eq_id` int(5) NOT NULL COMMENT 'รหัส',
  `type_eq` varchar(200) NOT NULL COMMENT 'ประเภทครุภัณฑ์',
  `shelf_life_eq` int(2) NOT NULL COMMENT 'อายุการใช้งาน',
  `eq_code` int(5) NOT NULL COMMENT 'รหัสตามประเภทครุภัณฑ์	',
  `last_update` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `type_eq` (`type_eq_id`, `type_eq`, `shelf_life_eq`, `eq_code`, `last_update`) VALUES
(1, 'ครุภัณฑ์สำนักงาน', 0, 0, '0000-00-00'),
(2, 'ครุภัณฑ์ยานพาหนะเเละขนส่ง', 0, 0, '0000-00-00'),
(3, 'ครุภัณฑ์การเกษตร', 0, 0, '0000-00-00'),
(4, 'ครุภัณฑ์ก่อสร้าง', 0, 0, '0000-00-00'),
(5, 'ครุภัณฑ์ไฟฟ้าเเละวิทยุ', 0, 0, '0000-00-00'),
(6, 'ครุภัณฑ์โฆษณาเเละการเผยเเพร่', 0, 0, '0000-00-00'),
(7, 'ครุภัณฑ์วิทยาศาสตร์เเละการเเพทย์', 0, 0, '0000-00-00'),
(8, 'ครุภัณฑ์งานบ้านเเละงานครัว', 0, 0, '0000-00-00'),
(9, 'ครุภัณฑ์โรงงาน', 0, 0, '0000-00-00'),
(10, 'ครุภัณฑ์กีฬา', 0, 0, '0000-00-00'),
(11, 'ครุภัณฑ์สนาม,สำรวจ', 0, 0, '0000-00-00'),
(12, 'ครุภัณฑ์ดนตรีเเละนาฎศิลป์', 0, 0, '0000-00-00'),
(13, 'ครุภัณฑ์คอมพิวเตอร์', 0, 0, '0000-00-00'),
(14, 'ครุภัณฑ์การศึกษา', 0, 0, '0000-00-00'),
(15, 'ครุภัณฑ์อาวุธ\r\n', 0, 0, '0000-00-00');
...
CREATE TABLE `user` (
  `user_id` int(11) NOT NULL COMMENT 'รหัสของผู้ใช้งาน',
  `userlevel` varchar(200) NOT NULL COMMENT 'สถานะผู้ใช้งาน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `user` (`user_id`, `userlevel`) VALUES
(1, 'ผู้ดูเเลระบบ'),
(2, 'เจ้าหน้าที่'),
(3, 'หน่วยงาน');
...
--
-- Indexes for table `fo_study`
--
ALTER TABLE `fo_study`
...
--
-- Indexes for table `stab_distributor`
--
ALTER TABLE `stab_distributor`
  ADD PRIMARY KEY (`sd_id`);

--
-- Indexes for table `status_dis`
--
ALTER TABLE `status_dis`
  ADD PRIMARY KEY (`std_id`);

--
-- Indexes for table `status_eq`
--
ALTER TABLE `status_eq`
  ADD PRIMARY KEY (`st_id`);

--
-- Indexes for table `subcategory_eq`
--
ALTER TABLE `subcategory_eq`
  ADD PRIMARY KEY (`sub_id`);

--
-- Indexes for table `tansfer`
--
ALTER TABLE `tansfer`
...
--
ALTER TABLE `agency`
  MODIFY `agc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT for table `company`
--
ALTER TABLE `company`
  MODIFY `cp_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `disbursement`
--
ALTER TABLE `disbursement`
  MODIFY `db_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสเบิกจ่ายครุภัณฑ์', AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `equipment`
--
ALTER TABLE `equipment`
  MODIFY `eq_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `fo_study`
--
ALTER TABLE `fo_study`
  MODIFY `id_fo` int(11) NOT NULL AUTO_INCREMENT COMMENT 'field of study', AUTO_INCREMENT=54;
...
--
ALTER TABLE `money_type`
  MODIFY `mon_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `personnel`
--
ALTER TABLE `personnel`
  MODIFY `per_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสบุคลากร', AUTO_INCREMENT=86;
...
--
-- AUTO_INCREMENT for table `stab_distributor`
--
ALTER TABLE `stab_distributor`
  MODIFY `sd_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสแทงจำหน่าย', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `status_dis`
--
ALTER TABLE `status_dis`
  MODIFY `std_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `status_eq`
--
ALTER TABLE `status_eq`
  MODIFY `st_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `subcategory_eq`
--
ALTER TABLE `subcategory_eq`
  MODIFY `sub_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=391;

--
-- AUTO_INCREMENT for table `tansfer`
--
ALTER TABLE `tansfer`
  MODIFY `tr_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสโอนย้ายครุภัณฑ์ ', AUTO_INCREMENT=20;
...
--
ALTER TABLE `type_eq`
  MODIFY `type_eq_id` int(5) NOT NULL AUTO_INCREMENT COMMENT 'รหัส', AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสของผู้ใช้งาน', AUTO_INCREMENT=4;
