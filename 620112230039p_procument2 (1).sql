...
--
-- Database: `620112230039p_procument2`
--
...
CREATE TABLE `agencys` (
  `agency_id` int(11) NOT NULL COMMENT 'รหัสประเภทหน่วยงาน	',
  `agency_name` varchar(200) NOT NULL COMMENT 'ประเภทหน่วยงาน'
...
INSERT INTO `agencys` (`agency_id`, `agency_name`) VALUES
(1, 'สำนักส่งเสริมวิชาการและงานทะเบียน'),
(2, 'สำนักวิทยบริการและเทคโนโลยีสารสนเทศ'),
(3, 'สำนักประกันคุณภาพการศึกษาและตรวจสอบภายใน'),
(4, 'สำนักศิลปะและวัฒนธรรม'),
(5, 'สถาบันวิจัยและพัฒนา'),
(6, 'สำนักงานอธิการบดี'),
(7, 'สำนักงานต่างประเทศ'),
(8, 'สำนักงานบริการทางวิชาการ'),
(9, 'ศูนย์คอมพิวเตอร์และอินเทอร์เน็ต'),
(10, 'ศูนย์วิทยบริการ'),
(11, 'ศูนย์เทคโนโลยีการศึกษา'),
(12, 'ศูนย์บ่มเพาะวิสาหกิจ'),
(13, 'ศูนย์วิทยาศาสตร์ประยุกต์'),
(14, 'กองการบริหารงานบุคคล'),
(15, 'กองนโยบายและแผน'),
(16, 'กองพัฒนานักศึกษา'),
(17, 'กองอาคารสถานที่และบริการ'),
(18, 'กองทุนเงินให้กู้ยืมเพื่อการศึกษา'),
(19, 'งานธุรการ'),
(20, 'งานพัสดุ'),
(21, 'งานการเงิน'),
(22, 'งานประชาสัมพันธ์'),
(23, 'งานก่อสร้าง'),
(24, 'งานอนุรักษ์พลังงาน'),
(25, 'งานสวัสดิการ'),
(26, 'งานอนามัย'),
(27, 'งานยานพาหนะ'),
(28, 'ฝ่ายทรัพย์สิน'),
...
(30, 'พนมพิมาน'),
(31, 'สภามหาวิทยาลัย'),
(32, 'สภาคณาจารย์และข้าราชการ'),
(33, 'บัณฑิตวิทยาลัย'),
(47, 'คณะครุศาสตร์'),
(48, 'คณะเทคโนโลยีอุตสาหกรรม'),
(49, 'คณะเทคโนโลยีการเกษตร'),
(50, 'คณะมนุษยศาสตร์และสังคมศาสตร์'),
(51, 'คณะวิทยาศาสตร์'),
(52, 'คณะวิทยาการจัดการ'),
(53, 'คณะพยาบาลศาสตร์');
...
CREATE TABLE `amphures` (
  ...
  `name_tha` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `amphures` (`id`, `code`, `name_tha`, `name_en`, `province_id`) VALUES
...
CREATE TABLE `branchs` (
  `branch_id` int(11) NOT NULL COMMENT 'field of study',
  `branch_name` varchar(200) CHARACTER SET utf8 NOT NULL COMMENT 'ชื่อสาขา',
  `branch_faculty_id` int(200) NOT NULL COMMENT 'รหัสประเภทหน่วยงาน',
  `branch_agency_id` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `branchs` (`branch_id`, `branch_name`, `branch_faculty_id`, `branch_agency_id`) VALUES
(1, 'ภาษาอังกฤษ(ค.บ.)', 1, 47),
(2, 'ดนตรีศึกษา(ค.บ.)', 1, 47),
(3, 'คณิตศาสตร์(ค.บ.)	', 1, 47),
(4, 'นาฏศิลป์(ค.บ.)', 1, 47),
(5, 'ศิลปศึกษา(ค.บ.)	', 1, 47),
(6, 'ภาษาไทย(ค.บ.)', 1, 47),
(7, 'พลศึกษา(ค.บ.)', 1, 47),
(8, 'สังคมศึกษา(ค.บ.) ', 1, 47),
(9, 'ฟิสิกส์(ค.บ.)', 1, 47),
(10, 'วิทยาศาสตร์(ค.บ.)', 1, 47),
(11, 'การศึกษาปฐมวัย(ค.บ.)', 1, 47),
(12, 'เทคโนโลยีและคอมพิวเตอร์เพื่อการศึกษา(ค.บ.)', 1, 47),
(13, 'ภูมิสารสนเทศ(วท.บ.)', 5, 51),
(14, 'เคมี(วท.บ.)', 5, 51),
(15, 'วิทยาศาสตร์สิ่งแวดล้อม(วท.บ.)', 5, 51),
(16, 'สาธารณสุขชุมชน(วท.บ.)', 5, 51),
(17, 'สถิติประยุกต์(วท.บ.)', 5, 51),
(18, 'ชีววิทยา(วท.บ.)', 5, 51),
(19, 'เทคโนโลยีสารสนเทศ(วท.บ.)', 5, 51),
(20, 'วิทยาการคอมพิวเตอร์(วท.บ.)', 5, 51),
(21, 'คณิตศาสตร์(วท.บ.)', 5, 51),
(22, 'วิทยาศาสตร์การกีฬา(วท.บ.)', 5, 51),
(23, 'วิทยาศาสตร์สิ่งทอ(วท.บ.)', 5, 51),
(24, 'วิทยาศาสตร์การอาหาร(วท.บ.)', 5, 51),
(25, 'เกษตรศาสตร์(วท.บ.)', 3, 49),
(26, 'ประมง(วท.บ.)', 3, 49),
(27, 'สัตวศาสตร์(วท.บ.)', 3, 49),
(28, 'การบัญชี(บช.บ.)', 6, 52),
(29, 'การสื่อสารมวลชน(นศ.บ.)', 6, 52),
(30, 'การท่องเที่ยวและการโรงแรม(ศศ.บ.)', 6, 52),
(31, 'เศรษฐศาสตร์(ศ.บ.)', 6, 52),
(32, 'การเงินและการธนาคาร(บธ.บ.)', 6, 52),
(33, 'การจัดการ(บธ.บ.)', 6, 52),
(34, 'การตลาด(บธ.บ.)', 6, 52),
(35, 'การบริหารทรัพยากรมนุษย์(บธ.บ.)', 6, 52),
(36, 'คอมพิวเตอร์ธุรกิจ(บธ.บ.)', 6, 52),
(37, 'การพัฒนาสังคม(ศศ.บ.)', 4, 50),
(38, 'ภาษาไทย(ศศ.บ.)', 4, 50),
(39, 'บรรณารักษ์ศาสตร์และสารสนเทศศาสตร์(ศศ.บ.)', 4, 50),
(40, 'ภาษาอังกฤษ(ศศ.บ.)', 4, 50),
(41, 'ภาษาอังกฤษธุรกิจ(ศศ.บ.)', 4, 50),
(42, 'ดนตรีสากล(ศศ.บ.)', 4, 50),
(43, 'คอมพิวเตอร์ศิลปะและการออกแบบ(ศศ.บ.)', 4, 50),
(44, 'รัฐประศาสนศาสตร์(รป.บ.)', 4, 50),
(45, 'นิติศาสตร์(น.บ.)', 4, 50),
(46, 'สถาปัตยกรรม(วท.บ.)', 2, 48),
(47, 'เทคโนโลยีการจัดการอุตสาหกรรม(วท.บ.)', 2, 48),
(48, 'เทคโนโลยีก่อสร้าง(วท.บ.)', 2, 48),
(49, 'เทคโนโลยีวิศวกรรมไฟฟ้า(วท.บ.)', 2, 48),
(50, 'เทคโนโลยีเซรามิกส์(วท.บ.)', 2, 48),
(51, 'อิเล็กทรอกนิกส์สื่อสาร(วท.บ.)', 2, 48),
(52, 'การออกแบบผลิตภัณฑ์อุตสาหกรรม(วท.บ.)', 2, 48),
(53, 'พยาบาลศาสตร์', 7, 53);
...
CREATE TABLE `disbursements` (
  ...
  `db_title` varchar(200) NOT NULL,
  `db_fname` varchar(200) NOT NULL,
  `db_lname` varchar(200) NOT NULL,
  `db_position` varchar(200) NOT NULL,
  `db_status` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `disbursements` (`disbursement_id`, `db_title`, `db_fname`, `db_lname`, `db_position`, `db_status`) VALUES
(1, 'นาง', 'พิมพ์ลภัส', 'ยอดไฟอินทร์', 'หัวหน้าหน่วยงาน', 1),
(2, 'นางสาว', 'pimlapat', 'yodfaiin', 'อาารย์', 1),
(3, 'นางสาว', 'ป๊อบ', 'แสนดี', 'อาารย์', 1),
(4, 'นาย', 'อิปแ', ' อปแ', 'หัวหน้าหน่วยงาน', 1);

-- --------------------------------------------------------

--
-- Table structure for table `disbursements_eq`
--

CREATE TABLE `disbursements_eq` (
  `disbursement_eq_id` int(11) NOT NULL COMMENT 'รหัสเบิกจ่ายครุภัณฑ์',
  `db_agency_id` int(11) NOT NULL COMMENT 'รหัสหน่วยงาน',
  `db_number` varchar(200) NOT NULL COMMENT 'หมายเลขครุภัณฑ์',
  `db_sub_id` text NOT NULL COMMENT 'รายการครุภัณฑ์',
  `db_amount` int(11) NOT NULL COMMENT 'จำนวนครุภัณฑ์',
  `db_status_eq_id` varchar(200) NOT NULL COMMENT 'สถานะครุภัณฑ์',
  `db_type_id` varchar(200) NOT NULL COMMENT 'ประเภทครุภัณฑ์',
  `db_date` date NOT NULL COMMENT 'วันที่รับ',
  `db_contract_num` int(200) NOT NULL COMMENT 'เลขที่สัญญา',
  `db_company` int(200) NOT NULL COMMENT 'ผู้ขาย(บริษัท,ห้าง,ร้าน)',
  `db_location` varchar(200) NOT NULL COMMENT 'สถานที่ใช้งาน',
  `db_money_id` varchar(200) NOT NULL COMMENT 'งบที่ใช้',
  `db_price` int(50) NOT NULL COMMENT 'ราคา',
  `db_note` text NOT NULL COMMENT 'หมายเหตุ',
  `db_generation` text NOT NULL COMMENT 'ขนาดและลักษณะ',
  `db_unit_id` varchar(200) NOT NULL COMMENT 'หน่วยนับ',
  `db_branch_id` varchar(200) NOT NULL COMMENT 'สาขา',
  `db_status` int(10) NOT NULL COMMENT 'เก็บสถานะการเบิก',
  `disbursement_id` int(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `disbursements_eq`
--

INSERT INTO `disbursements_eq` (`disbursement_eq_id`, `db_agency_id`, `db_number`, `db_sub_id`, `db_amount`, `db_status_eq_id`, `db_type_id`, `db_date`, `db_contract_num`, `db_company`, `db_location`, `db_money_id`, `db_price`, `db_note`, `db_generation`, `db_unit_id`, `db_branch_id`, `db_status`, `disbursement_id`) VALUES
(21, 6, 'pp/852', '19', 1, '0', '1', '2022-04-29', 44, 0, 'อาคาร12', 'งบรายได้', 25830, '--', '--', 'ตัว', 'วิทยาศาสตร์สิ่งแวดล้อม(วท.บ.)', 1, 0),
(22, 17, 'nm', '329', 235, '0', '6', '2022-03-30', 44, 0, 'ดเ้ื่ทก้ดเ', 'งบแผ่นดิน', 424, '4252', '่าเ้ก่า้่าส', 'เครื่อง', 'สถิติประยุกต์(วท.บ.)', 1, 0),
(23, 52, 'pp/852', '2', 545, '0', '1', '2022-05-20', 22, 0, 'อาคาร12', 'งบแผ่นดิน', 56456456, 'fgsdxv', 'xcfvb', 'เครื่อง', '31', 0, 0),
(24, 52, 'nm', '2', 3, '0', '1', '2022-05-10', 0, 0, 'zsdxgv', 'งบแผ่นดิน', 3, 'sdZFv', 'xczvb', 'อัน', '30', 0, 0),
(25, 1, 'pp/852', '131', 32133, '0', '3', '2022-05-12', 0, 0, 'x', 'งบพนมพิมาน', 21, 'das', 'a', 'ตัว', '', 0, 0),
(26, 12, 'pp/852', '128', 545, '0', '3', '2022-05-10', 0, 0, ' zxvbn', 'งบแผ่นดิน', 456, 'das', 'a', 'อัน', '', 0, 0),
(27, 15, '11111111111111111', '98', 1212, '0', '2', '2022-05-16', 0, 2, '22', 'งบรับฝาก 50%', 212, '1', '2', 'ตัว', '', 0, 0),
(28, 13, '111111111111111123', '1', -1, '0', '1', '2022-05-11', 0, 6, '22', 'งบแผ่นดิน', 66, '2', '3', 'ตัว', '', 0, 2),
(29, 50, '6626', '2', 3, '0', '1', '2022-05-15', 22, 0, 'cftgyk', 'งบพนมพิมาน', 444, 'fsdtg', 'nhjvbk', 'ตัว', '38', 0, 2),
(30, 3, 'nm', '2', 2, '0', '1', '2022-05-11', 0, 0, 'อาคาร12', 'งบรายได้', 22, 'dfggv', 'sftgh', 'ชุด', '', 1, 2),
(31, 53, 'nm', '3', 1, '1', '1', '2022-05-27', 0, 0, 'xdghf', 'งบแผ่นดิน', 52, 'dfgh', 'tfyhg', 'ตัว', '53', 0, 2),
(32, 48, '12357', '11', 1, '1', '1', '2022-05-23', 123, 0, 'อาคาร12', 'งบแผ่นดิน', 1230, '--', 'เล็ก', 'ตัว', '46', 0, 3),
(33, 16, 'pp/852', '2', 1, '3', '1', '2022-06-01', 0, 0, ' zxvbn', 'งบรายได้', 33, 'sdcc', 'fff', 'อัน', '', 0, 3);
...
CREATE TABLE `districts` (
  ...
  `name_thd` varchar(150) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `districts` (`id`, `zip_code`, `name_thd`, `name_en`, `amphure_id`) VALUES
...
CREATE TABLE `equipments` (
  ...
  `eq_number` varchar(200) NOT NULL COMMENT 'หมายเลขครุภัณฑ์ ',
  `eq_sub_id` text NOT NULL COMMENT 'รายการหมวดหมู่ย่อยครุภัณฑ์',
  `eq_type_id` varchar(200) NOT NULL COMMENT 'รหัสประเภทครุภัณฑ์  ',
  `eq_generation` text NOT NULL COMMENT 'ขนาด/ลักษณะ',
  `eq_buydate` date NOT NULL COMMENT 'วันเดือนปีที่ซื้อ',
  `eq_location` varchar(200) NOT NULL COMMENT 'สถานที่ตั้ง  ',
  `eq_agency_id` varchar(200) NOT NULL COMMENT 'หน่วยงาน',
  `eq_money_id` varchar(200) NOT NULL COMMENT 'รหัสประเภทเงิน',
  `eq_unit_id` varchar(200) NOT NULL COMMENT 'หน่วยนับ',
  `eq_price` text NOT NULL COMMENT 'ราคาต่อหน่วย',
  `eq_status_id` varchar(200) NOT NULL COMMENT 'สถานะครุภัณฑ์',
  `eq_note` text NOT NULL COMMENT 'หมายเหตุ',
  `eq_company` varchar(200) NOT NULL COMMENT 'บริษัท/ห้าง/ร้าน',
  `eq_branch_id` varchar(200) NOT NULL COMMENT 'สาขา',
  `eq_fiscal_year` year(4) NOT NULL COMMENT 'ปีงบประมาณ',
  `eq_type_list_id` int(200) NOT NULL COMMENT 'รายการประเภทย่อย',
  `lifetime` int(200) NOT NULL COMMENT 'อส\r\nอายุการใช้งานปัจุบัน',
  `type_lifetime_low` int(200) NOT NULL COMMENT 'อายุการใช้งานตามกำหนด',
  `eq_date_calculate` date DEFAULT NULL COMMENT 'วันที่คำนวณค่าเสื่อม',
  `eq_type_depreciation` int(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `equipments` (`equipment_id`, `eq_number`, `eq_sub_id`, `eq_type_id`, `eq_generation`, `eq_buydate`, `eq_location`, `eq_agency_id`, `eq_money_id`, `eq_unit_id`, `eq_price`, `eq_status_id`, `eq_note`, `eq_company`, `eq_branch_id`, `eq_fiscal_year`, `eq_type_list_id`, `lifetime`, `type_lifetime_low`, `eq_date_calculate`, `eq_type_depreciation`) VALUES
(35, '12354/2556', '2', '1', 'ัี่', '2022-07-15', 'อาคาร25', '50', 'งบรายได้', 'อัน', '1233', 'พร้อมใช้งาน', '121323', 'ิอ', '40', 2022, 0, 0, 12, '2022-09-30', 1),
(37, '12354/2556', '1', '1', 'gbfv', '2022-07-06', 'อาคาร25', '52', 'งบรายได้', 'อัน', '45', 'พร้อมใช้งาน', 'fgvbfg', 'gvbf', '35', 0000, 0, 0, 3, '2022-09-30', 1);
...
CREATE TABLE `moneys` (
  `money_id` int(5) NOT NULL,
  `money_type` varchar(200) NOT NULL COMMENT 'ประเภทเงิน',
...
INSERT INTO `moneys` (`money_id`, `money_type`, `last_update`) VALUES
(1, 'งบรายได้', '2000-02-10'),
(2, 'งบแผ่นดิน', '0000-00-00'),
(3, 'งบพนมพิมาน', '0000-00-00'),
(4, 'งบรับฝาก 50%', '0000-00-00'),
(5, 'งบรับฝาก30% หอพัก', '0000-00-00'),
(6, 'งบรับฝากวิจัย', '0000-00-00'),
(7, 'งบเงินกันเหลื่อมปี', '0000-00-00'),
(8, 'งบรับฝากโครงการห้องเรียน 3', '0000-00-00'),
(9, 'งบรายได้ 30% หอประชุม', '0000-00-00'),
(10, 'งบ 50% กบ.กช', '0000-00-00'),
(11, 'งบบริจาค', '0000-00-00');
...
CREATE TABLE `positions` (
  ...
  `position_name` varchar(200) NOT NULL COMMENT 'ตำแหน่งงาน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `status_equipment` (
  ...
  `status_name` varchar(200) NOT NULL COMMENT 'ชื่อสถานะ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `subcategorys` (
  ...
  `sub_name` varchar(200) NOT NULL COMMENT 'หมวดหมู่ย่อย',
  `sub_eq_code` int(11) NOT NULL COMMENT 'รหัสหมวดหมู่ย่อย',
  `sub_age` varchar(200) NOT NULL COMMENT 'อายุการใช้งาน',
  `type_list_id` int(200) NOT NULL COMMENT 'รหัสประเภทย่อ2',
  `type_lifetime_low` int(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='หมวดหมู่ย่อย(เเบ่งตามประเภท)';

--
-- Dumping data for table `subcategorys`
--

INSERT INTO `subcategorys` (`sub_id`, `sub_name`, `sub_eq_code`, `sub_age`, `type_list_id`, `type_lifetime_low`) VALUES
(1, 'เก้าอี้', 1, '', 0, 3),
(2, 'โต๊ะ', 1, '', 0, 3),
(3, 'ม้านั่ง\r\n', 1, '', 0, 3),
(4, 'ตู้ดรรชนี', 1, '', 0, 3),
(5, 'ตู้โชว์', 1, '', 0, 3),
(6, 'ตู้เก็บเอกสาร', 1, '', 0, 3),
(7, 'ตู้นิรภัย', 1, '', 0, 3),
(8, 'ชั้นเก็บหนังสือ', 1, '', 0, 3),
(9, 'เครื่องดูดฝุ่น', 1, '', 0, 3),
(10, 'เครื่องขัดพิ้น', 1, '', 0, 3),
(11, 'เครื่องคำนวณ(เครื่องคิดเลข)', 1, '', 0, 3),
(12, 'เครื่องบวกเลข', 1, '', 0, 3),
(13, 'เครื่องชุมสายโทรศัพท์', 1, '', 0, 3),
(14, 'ตู้โทรศัพท์', 1, '', 0, 3),
(15, 'เครื่องโทรศัพท์', 1, '', 0, 3),
(16, 'เครื่องโทรพิมพ์(โทรสาร)', 1, '', 0, 3),
(17, 'เครื่องพิมพ์ดีด', 1, '', 0, 3),
(18, 'เครื่องอัดสำเนา(เครื่องโรเนียว)', 1, '', 0, 3),
(19, 'เครื่องถ่ายเอกสาร', 1, '', 0, 3),
(20, 'เครื่องปรุกระดาษไข', 1, '', 0, 3),
(21, 'เครื่องปรับอากาศ', 1, '', 0, 3),
(22, 'เครื่องรับเงิน/เครื่องบัยทึกเงิน', 1, '', 0, 3),
(23, 'กำปั่นเก็บเงิน', 1, '', 0, 3),
(24, 'หีบเหล็กเก็บเงิน', 1, '', 0, 3),
(25, 'ชุดรับเเขก', 1, '', 0, 3),
(26, 'เคาน์เตอร์\r\n', 1, '', 0, 3),
(27, 'มู่ลี่/ผ้าม่าน', 1, '', 0, 3),
(28, 'พรม', 1, '', 0, 3),
(29, 'นาฬิกา', 1, '', 0, 3),
(30, 'เเท่นอ่านหนังสือ,เเท่นวางโทรศัพท์', 1, '', 0, 3),
(31, 'ผังเเสดงวงจรต่างๆ', 1, '', 0, 3),
(32, 'เเผงบังคับทางไฟ', 1, '', 0, 3),
(33, 'พัดลม', 1, '', 0, 3),
(34, 'ไฟฉายสปอทไลท์ขนาดเกินกว่า 500 เเรงเทียนขึ้นไป', 1, '', 0, 3),
(35, 'รถเข็น', 1, '', 0, 3),
(36, 'ถังเหล็กบรรจุน้ำ', 1, '', 0, 3),
(37, 'พระพุทธรูป,พระบรมรูปจำลอง', 1, '', 0, 3),
(38, 'ตราพระราชลัญจกร', 1, '', 0, 3),
(39, 'เครื่องจับเวลา', 1, '', 0, 3),
(40, 'เครื่องชั่ง', 1, '', 0, 3),
(41, 'เครื่องพืมสำเนาระบบดิจิตอล', 1, '', 0, 3),
(42, 'ตู้ลำโพง', 1, '', 0, 3),
(43, 'ตู้ชั้นวางของ', 1, '', 0, 3),
(44, 'เครื่องเพรทกระดาษ/เครื่องพับกระดาษ', 1, '', 0, 3),
(45, 'นั่งร้านเหล็ก/เวที', 1, '', 0, 3),
(46, 'เครื่องปั๊มเลขเช็ค', 1, '', 0, 3),
(47, 'เครื่องตัดกระดาษ', 1, '', 0, 3),
(48, 'ตู้ใล่สไลด์', 1, '', 0, 3),
(49, 'โต๊ะหมูบูชา', 1, '', 0, 3),
(50, 'ป้ายต่างๆ', 1, '', 0, 3),
(51, 'กระดานดำ(บอร์ด)ฉากกั้นห้อง', 1, '', 0, 3),
(52, 'เครื่องเย็บกระดาษไฟฟ้า', 1, '', 0, 3),
(53, 'เครื่องดับเพลิง', 1, '', 0, 3),
(54, 'เครื่องมือเขียนรายละเอียดตัวอักษร ตัวเลขเเละสัฯญลักษณ์/ปากกาอิเล็คทรอนิกส์', 1, '', 0, 3),
(55, 'เครื่องถ่ายแผ่นโปร่งใส', 1, '', 0, 3),
(56, 'แผ่นอัดสำเนา', 1, '', 0, 3),
(57, 'เครื่องพิมพ์คอมพิวเตอร์', 1, '', 0, 3),
(58, 'เครื่องขับแผ่นจานแม่เหล็ก', 1, '', 0, 3),
(59, 'เครื่องตอกตาไก่', 1, '', 0, 3),
(60, 'เครื่องฉายไมโครฟิล์ม', 1, '', 0, 3),
(61, 'เครื่องย่อกระดาษ', 1, '', 0, 3),
(62, 'ผนึกพลาสติก(เครื่องเคลือบบัตร)', 1, '', 0, 3),
(63, 'เครื่องพิมพ์ออฟเซท', 1, '', 0, 3),
(64, 'เครื่องไมโครคอมพิวเตอร์(คอมพิวเตอร์,จอ,หน่วยความจำ)', 1, '', 0, 3),
(65, 'เครื่องทำลายเอกสาร', 1, '', 0, 3),
(66, 'เครื่องตอกตัวเลข', 1, '', 0, 3),
(67, 'ที่งัดลวดเย็บขนาดใหญ่', 1, '', 0, 3),
(68, 'เครื่องเจาะเข้าเล่ม', 1, '', 0, 3),
(69, 'เครื่องพิมพ์ EPSON', 1, '', 0, 3),
(70, 'เครื่องควบคุมกระแสไฟฟ้า', 1, '', 0, 3),
(71, 'โต๊ะวางเครื่องคอมพิวเตอร์', 1, '', 0, 3),
(72, 'โต๊ะวางเครื่องพิมพ์', 1, '', 0, 3),
(73, 'อุปกรณ์การพิมพ์ประกอบชุดไมโครคอมพิวเตอร์', 1, '', 0, 3),
(74, 'เครื่องโมเดม', 1, '', 0, 3),
(75, 'เครื่องดิคชั่นรี่(Dictionary)', 1, '', 0, 3),
(76, 'แสตน(แท่นบรรยาย)', 1, '', 0, 3),
(77, 'เครื่องตรวจข้อสอบ', 1, '', 0, 3),
(78, 'อุปกรณ์เชื่อมต่อเครือข่าย Hub', 1, '', 0, 3),
(79, 'โปรแกรมคอมพิวเตอร์', 1, '', 0, 3),
(80, 'เครื่องฉายภาพคอมพิวเตอร์', 1, '', 0, 3),
(81, 'โปรแกรมห้องสมุด', 1, '', 0, 3),
(82, 'เครื่องทำตรายาง', 1, '', 0, 3),
(83, 'เครื่องเรียงข้อสอบ', 1, '', 0, 3),
(84, 'เครื่องพิมพ์รหัสเเท่ง', 1, '', 0, 3),
(85, 'เคริ่องอ่านบาร์โค๊ดมือถือ/เครื่องควบคุมการเข้า-ออก', 1, '', 0, 3),
(86, 'เครื่องสัญญาณกันโขมย(เครื่องตรวจเช็คหนังสือทางเข้าออก)', 1, '', 0, 3),
(87, 'เครื่องอัดหนังสือ', 1, '', 0, 3),
(88, 'เคึรื่องฟอกอากาศ', 1, '', 0, 3),
(89, 'เครื่องสร้างหมอก', 1, '', 0, 3),
(90, 'ตราดุน(พร้อมแท่น)', 1, '', 0, 3),
(91, 'ปืนยิงลูกเม็ด', 1, '', 0, 3),
(92, 'เกจวัดเเรงดัน(แอร์)', 1, '', 0, 3),
(93, 'ชุดล้างท่อน้ำยาแอร์', 1, '', 0, 3),
(94, 'เครื่องจัดระบบบัตรคิว', 1, '', 0, 3),
(95, 'รถยนต์นั่ง,เก๋ง,ตู้', 2, '', 0, 5),
(96, 'รถยนต์โดยสาร(บัส)', 2, '', 0, 5),
(97, 'รถยกของ', 2, '', 0, 5),
(98, 'รถปั้นจั่น', 2, '', 0, 5),
(99, 'รถบรรทุก(ปิคอัพ)', 2, '', 0, 5),
(100, 'รถลากเครื่องบิน', 2, '', 0, 5),
(101, 'รถเทลเลอร์', 2, '', 0, 5),
(102, 'รถดับเพลิง', 2, '', 0, 5),
(103, 'รถเข็น', 2, '', 0, 5),
(104, 'รถจักรยานยนต์', 2, '', 0, 5),
(105, 'รถจักรยาน2ล้อ', 2, '', 0, 5),
(106, 'เรือยนต์', 2, '', 0, 5),
(107, 'เรือบด', 2, '', 0, 5),
(108, 'เรือติดท้าย', 2, '', 0, 5),
(109, 'เรือเร็ว', 2, '', 0, 5),
(110, 'เรือพ่วง(รถพ่วง)', 2, '', 0, 5),
(111, 'เครื่องบิน', 2, '', 0, 5),
(112, 'รถยนต์สองแถวโดยสาร', 2, '', 0, 5),
(113, 'รถยนต์เกษตร,รถบรรทุกน้ำ', 2, '', 0, 5),
(114, 'เครื่องยนต์', 2, '', 0, 5),
(115, 'รถสามล้อถีบส่งของ', 2, '', 0, 5),
(116, 'รถโรยเส้นสนามกีฬา', 2, '', 0, 5),
(117, 'ชุดระบบห้ามล้อ', 2, '', 0, 5),
(118, 'เรือไฟเบอร์', 2, '', 0, 5),
(119, 'ถุงลม', 2, '', 0, 5),
(120, 'สัญญาณไฟฉุกเฉิน', 2, '', 0, 5),
(121, 'รถไฟฟ้า', 2, '', 0, 5),
(122, 'รถจักรยานยนต์ไฟฟ้า', 2, '', 0, 5),
(124, 'ปศุสัตว์', 3, '', 1, 0),
(125, 'รถไถ', 3, '', 2, 0),
(126, 'รถแทรกเตอร์ ', 3, '', 2, 0),
(127, 'จอบหมุน', 3, '', 1, 0),
(128, 'จานพรวน', 3, '', 1, 0),
(129, 'ผานไถกะทะ', 3, '', 1, 0),
(130, 'เครื่องตัดข้าวโพด ข้าวฟ่าง', 3, '', 2, 0),
(131, 'เครื่องตัดวัชพืช', 3, '', 2, 0),
(132, 'เครื่องหว่านปุ๋ย', 3, '', 1, 0),
(133, 'เครื่องหยอดหรือหว่านเมล็ดพันธ์', 3, '', 2, 0),
(134, 'เครื่องทำความสะอาดเมล็ดพันธ์', 3, '', 2, 0),
(135, 'เครื่องกระเทาะเมล็ดพืช', 3, '', 2, 0),
(136, 'เครื่องยกร่อง', 3, '', 1, 0),
(137, 'เครื่องนวดธัญพืช/เครื่องนวดข้าว', 3, '', 2, 0),
(138, 'เครื่องผสมยาคลุกเมล็ดพันธ์', 3, '', 2, 0),
(139, 'เครื่องนับเมล็ดพืช', 3, '', 2, 0),
(140, 'คราดซี่พรวนดินระหว่างเเถว', 3, '', 1, 0),
(141, 'ตู้เก็บเมล็ดพันธ์', 3, '', 1, 0),
(142, 'เครื่องรถน้ำ', 3, '', 1, 0),
(143, 'เครื่องสีข้าวโพด/สีข้าว', 3, '', 2, 0),
(144, 'เครื่องสีฝัด', 3, '', 2, 0),
(145, 'เครื่องเกลี่ยหญ้า', 3, '', 1, 0),
(146, 'เครื่องคราดหญ้า', 3, '', 1, 0),
(147, 'เครื่องดักแมลง', 3, '', 1, 0),
(148, 'เครื่องบดเเละผสมอาหารสัตว์/เครื่องอัดเม็ดอาหารปลา', 3, '', 2, 0),
(149, 'เครื่องพ่นยา', 3, '', 1, 0),
(150, 'เครื่องสูบน้ำ/เครื่องปั้มน้ำ', 3, '', 1, 0),
(151, 'ระหัด', 3, '', 1, 0),
(152, 'เครื่องขยายเกล็ดปลา', 3, '', 1, 0),
(153, 'ตะเเกรงร่อนเบนโธส', 3, '', 1, 0),
(154, 'อวน', 3, '', 1, 0),
(155, 'เครื่องสับผสม', 3, '', 2, 0),
(156, 'เครื่องวัดความหวานผลไม้', 3, '', 1, 0),
(157, 'เครื่องวัดการเจริญเติบโตของพืช/วัดความสูงพืช/เครื่องวัดส่วนต่างของพืช', 3, '', 1, 0),
(158, 'เครื่องตัวเนื้อเยื่อด้วยมือ', 3, '', 1, 0),
(159, 'เครื่องรีดน้ำเชื่อโค/รีดนม', 3, '', 1, 0),
(160, 'อุปกรณ์ผสมเทียม', 3, '', 1, 0),
(161, 'เครื่องตรวจการตั้งท้องสุกร', 3, '', 1, 0),
(162, 'เครื่องตรวจการเป็นสัดสุกร', 3, '', 1, 0),
(163, 'กรรไกรตัดกระดูก', 3, '', 1, 0),
(165, 'เครื่องถอนขนไก่', 3, '', 1, 0),
(166, 'เครื่องอัดฟาง', 3, '', 1, 0),
(167, 'ตู้ฟักไข่', 3, '', 1, 0),
(168, 'เครื่องตัดหญ้ารถไถ', 3, '', 1, 0),
(169, 'เครื่องทำเครื่องหมายสัตว์', 3, '', 1, 0),
(170, 'เครื่องวัดความนุ่มเนื้อ', 3, '', 1, 0),
(171, 'เครื่องวัดอัตราการซึมน้ำในดิน', 3, '', 1, 0),
(172, 'เครื่องทดสอบดิน/หม้อบดดิน', 3, '', 1, 0),
(173, 'เครื่องเจาะเก็บตัวอย่างดิน', 3, '', 1, 0),
(174, 'เครื่องวัดการปิดเปิดปากใบพืช', 3, '', 1, 0),
(175, 'ถังเก็บน้ำเชื้อ', 3, '', 1, 0),
(176, 'เครื่องวัดความชื้นชองเมล็ดพืช', 3, '', 1, 0),
(177, 'ซองบังคับสัตว์', 3, '', 1, 0),
(178, 'ชุดเทียบสีทางพืชสวน', 3, '', 1, 0),
(179, 'เครื่องอบเมล็ดพันธ์พืช', 3, '', 1, 0),
(180, 'เครื่องวิเคราะห์ตรวจสอบน้ำนม', 3, '', 1, 0),
(181, 'เครื่องปิดปากถุงอัตโนมัติ', 3, '', 2, 0),
(182, 'เครื่องวิเคราะห์เมล็ดพันธ์พืช', 3, '', 1, 0),
(183, 'เครื่องบรรจุกระป๋อง', 3, '', 2, 0),
(184, 'ถุงลากเเพลงตอน', 3, '', 1, 0),
(185, 'เครื่องวิเคราะห์เยื่อใย', 3, '', 1, 0),
(186, 'เครื่องวัดพื้นที่ของพืช', 3, '', 1, 0),
(187, 'เครื่องสกัดแลกน้ำผลไม้/ชุดเครื่องสกัดน้ำสมุนไพร', 3, '', 1, 0),
(188, 'เครื่องไล่อากาศ', 3, '', 1, 0),
(189, 'เครื่องวัดศักยภาพของน้ำในใบพืช/เครื่องวัดคลอโรฟิลล์', 3, '', 1, 0),
(190, 'เครื่องบรรจุของเหลวในถุงพลาสติก', 3, '', 2, 0),
(191, 'เครื่องอัดถุงเห็ด', 3, '', 1, 0),
(192, 'ชุดปลูกพืชในน้ำยา(ไฮโดรโฟนิก)', 3, '', 1, 0),
(193, 'เครื่องกระทุ้งดินหรือแอสฟัสท์', 4, '', 2, 0),
(194, 'เครื่องกลึง', 4, '', 2, 0),
(195, 'เครื่องเจาะหิน', 4, '', 2, 0),
(196, 'เครื่องเจาะเหล็ก/เครื่องกัดเหลา', 4, '', 2, 0),
(197, 'สว่านเจาะเเผ่นเหล็ก', 4, '', 1, 0),
(198, 'เครื่องเชื่อมโลหะ', 4, '', 1, 0),
(199, 'เครื่องพ่นสี,เครื่องพ่นทราย,พู่กันกินลม/เครื่องพ่นไฟ', 4, '', 1, 0),
(200, 'เครื่องผสมยางแอสฟัสท์', 4, '', 2, 0),
(201, 'ีเครื่องผสมคอนกรีต', 4, '', 2, 0),
(202, 'เครื่องมือทดสอบคอนกรีต', 4, '', 1, 0),
(203, 'เครื่องสั่นคอนกรีต', 4, '', 2, 0),
(204, 'เครื่องมือทดสอบความลาดเท', 4, '', 1, 0),
(205, 'เครื่องมือแกะสลัก', 4, '', 1, 0),
(206, 'เครื่องมือไสไม้ไฟฟ้า(กบไฟฟ้า)', 4, '', 1, 0),
(207, 'เลื่อยไฟฟ้า', 4, '', 1, 0),
(208, 'เครื่องมือดึงสายโทรศัพท์', 4, '', 1, 0),
(209, 'ตอกแม่แรง', 4, '', 1, 0),
(210, 'โซ่ลานพร้อมปอนด์ดึง', 4, '', 1, 0),
(211, 'รถเตาต้มยาง\r\n', 4, '', 2, 0),
(212, 'รถพ่นยาง', 4, '', 1, 0),
(213, 'รถดักดิน', 4, '', 2, 0),
(214, 'รถบด', 4, '', 2, 0),
(215, 'รถเกรดเดอร์', 4, '', 2, 0),
(216, 'รถกระบะเท', 4, '', 2, 0),
(217, 'รถอัดฉีด', 4, '', 2, 0),
(218, 'รถบรรทุกน้ำ', 4, '', 2, 0),
(219, 'รถบรรทุกน้ำมัน', 4, '', 2, 0),
(220, 'รถกวาดถนน', 4, '', 2, 0),
(221, 'รถเข็น', 4, '', 1, 0),
(222, 'เครื่องโม่หิน', 4, '', 2, 0),
(223, 'เครื่องตอกเข็ม', 4, '', 2, 0),
(224, 'เครื่องตีเส้น', 4, '', 1, 0),
(225, 'เครื่องอัดจารบี', 4, '', 1, 0),
(226, 'เครื่องอัดลม(เป่าลม,ปั้มลม)', 4, '', 1, 0),
(227, 'ไม้สค๊าฟ', 4, '', 1, 0),
(228, 'บันได', 4, '', 1, 0),
(229, 'เครื่องทดสอบการยุบตัวของคอนกรีต', 4, '', 1, 0),
(230, 'เครื่องขัดกระดาษทราย', 4, '', 2, 0),
(231, 'เครื่องมือตัดกระเบื้อง', 4, '', 1, 0),
(232, 'เวอร์เนียร์', 4, '', 1, 0),
(234, 'ค้อนทดสอบคอนกรีต', 4, '', 1, 0),
(235, 'แบบหล่อคอนกรีต', 4, '', 1, 0),
(236, 'นั่งร้านเหล็ก', 4, '', 1, 0),
(237, 'หน้ากากปรับแสงอัตโนมัติ', 4, '', 1, 0),
(238, 'เครื่องสกัดคอนกรีต', 4, '', 1, 0),
(239, 'เครื่องทดสอบหาขนาดของเม็ดดิน', 4, '', 1, 0),
(240, 'ชุดทดสอบหากำล้งต้านทางแรงเฉือนของดิน', 4, '', 1, 0),
(241, 'ชุดทดสอบหาความทรุดตัวของดิน', 4, '', 1, 0),
(242, 'ชุดทดสอบค่าความแข็งของวัตถุดิบ', 4, '', 1, 0),
(243, 'ชุดทดสอบหาหน่วยน้ำของมวล', 4, '', 1, 0),
(244, 'ชุดทดสอบการก่อตัวของซีเมนต์', 4, '', 1, 0),
(245, 'ชุดทดสอบความถ่วงจำเพาะ', 4, '', 1, 0),
(246, 'ชุดทดสอบการศึกกร่อนของหิน', 4, '', 1, 0),
(247, 'ชุดทดสอบการไหลซึม', 4, '', 1, 0),
(248, 'เครื่องยิงรีเวท', 4, '', 1, 0),
(249, 'เร้าเตอร์(เครื่องเซาะร่อง)', 4, '', 1, 0),
(250, 'ชุดปฎิบัติการช่างโลหะ', 4, '', 1, 0),
(251, 'ชุดทดสอบความสมบูรณ์ของชิ้นงานก่อสร้าง', 4, '', 1, 0),
(252, 'ชุดทดสอบไฮดรอลิค', 4, '', 1, 0),
(253, 'ชุดทดสอบเครื่องมือสร้างความจำลองอากาศ', 4, '', 1, 0),
(254, 'เครื่องกำเนิดไฟฟ้า', 5, '', 0, 5),
(255, 'หม้อเเปลงไฟฟ้า/โซล่าเซล', 5, '', 0, 5),
(256, 'เครื่องวัดเเรงดันไฟฟ้า(มอนิเตอร์)/เครื่องวัดค่าการนำไฟฟ้า', 5, '', 0, 5),
(257, 'มาตรสำหรับตรวจวงจรไฟฟ้า/มัลติมิเตอร์ดิจิตอล', 5, '', 0, 5),
(258, 'เครื่องประจุไฟฟ้า', 5, '', 0, 5),
(259, 'เครื่องขยายเสียง/เครื่องเสียง/เครื่องขยายเสียงอเนกประสงค์', 5, '', 0, 5),
(260, 'เครื่องบันทึกเสียง(เครื่องอัดเสียงสำเนาเทปเครื่องเล่น)', 5, '', 0, 5),
(261, 'เครื่องเล่นเเผ่นเสียง(เครื่องเล่น CD,DVD,MP3)', 5, '', 0, 5),
(262, 'เครื่องรับวิทยุ', 5, '', 0, 5),
(263, 'เครื่องส่งวิทยุ,วิทยุสื่อสาร', 5, '', 0, 5),
(264, 'เครื่องรับโทรทัศน์', 5, '', 0, 5),
(265, 'เครื่องส่งโทรทัศน์', 5, '', 0, 5),
(266, 'ไมโครโฟน', 5, '', 0, 5),
(267, 'ลำโพง', 5, '', 0, 5),
(268, 'เครื่องวัดความถี่คลื่น/เครื่องสร้างความถี่/ฟังชันก์เจนเนอร์เรเตอร์', 5, '', 0, 5),
(269, 'โคมไฟฟ้าพร้อมเสา', 5, '', 0, 5),
(270, 'โคมๆฟฟ้าติดโต๊ะ', 5, '', 0, 5),
(271, 'โคมเขียนเเบบ', 5, '', 0, 5),
(272, 'ขาตั้งไมโครโฟน', 5, '', 0, 5),
(273, 'เครื่องโทรสาร', 5, '', 0, 5),
(274, 'เครื่องเทปซิงโครไนซ์', 5, '', 0, 5),
(275, 'โทรศัพท์มือถือ', 5, '', 0, 5),
(276, 'เครื่องรับสัญญาณพร้อมจานดาวเทียม', 5, '', 0, 5),
(277, 'เครื่องขยายสัญญาณ/เเยกสัญญาณ/สลับสัญญาณ', 5, '', 0, 5),
(278, 'เครื่องควบคุมรั้วไฟฟ้า', 5, '', 0, 5),
(279, 'ชุดประธานเเละผู้ร่วมประชุม', 5, '', 0, 5),
(280, 'โปรเเกรมเมเบิลคอลโทรลเลอร์', 5, '', 0, 5),
(281, 'ชุดสร้างเสียงดนตรี', 5, '', 0, 5),
(282, 'เครื่องควบบคุมเวลาอัตโนมัติ/ชุดควบคุมอัตโนมัติงานอุตสาหกรรม', 5, '', 0, 5),
(283, 'เครื่องชั่งสารไฟฟ้า', 5, '', 0, 5),
(284, 'บูสเตอร์มิกเซอร์', 5, '', 0, 5),
(285, 'เครื่องซีคอนเซอร์(ควบคุมสัญญาณเสียง)', 5, '', 0, 5),
(286, 'เครื่องเเพทเทอนเย็นเนอร์เรเตส(จูลโทรทัศน์)', 5, '', 0, 5),
(287, 'ชุดปฎิบัติการทางภาษา', 5, '', 0, 5),
(288, 'ชุดทดลองวงจรอิเล็กทรอนิกส์', 5, '', 0, 5),
(289, 'เเท่นชาร์จเเบตเตอรี่', 5, '', 0, 5),
(290, 'เครื่องเเต่งเสียง/ปรีเเอมป์/ปรีไมค์', 5, '', 0, 5),
(291, 'มอเตอร์ไฟฟ้า', 5, '', 0, 5),
(292, 'อุปกรณ์ป้องกันฟ้าผ่า', 5, '', 0, 5),
(293, 'ตู้คอลโทรลไฟฟ้า', 5, '', 0, 5),
(294, 'เครื่องวัดสัญญาณไฟฟ้า(ออสสิโลสโคป)/เครื่องทือวัดอิเล็คทรอนนิกส์', 5, '', 0, 5),
(295, 'เครื่องทดสอบระบบโทรศัทพ์', 5, '', 0, 5),
(296, 'เครื่องควบคุมลำโพง', 5, '', 0, 5),
(297, 'ตู้เเร็ค', 5, '', 0, 5),
(298, 'เครื่องผสมเสียงสัญญาณเสียง(มิกเซอร์)', 5, '', 0, 5),
(299, 'ชุดผลิตสื่อสารการสอนนอกสถานที่', 5, '', 0, 5),
(300, 'เครื่องควบคุมไฟฟ้า(เบรกเกอร์)/รีโมท', 5, '', 0, 5),
(301, 'ไม้ชักฟิว', 5, '', 0, 5),
(302, 'ถุงมือกันไฟ', 5, '', 0, 5),
(303, 'เข็มขัดขึ้นเสา', 5, '', 0, 5),
(304, 'โต๊ะปฎิบัติการไฟฟ้า', 5, '', 0, 5),
(305, 'ชุดฝึกปฎิบัติการขนส่งวัสดุ', 5, '', 0, 5),
(306, 'ชุดฝึกปฎิบัติการจำลองของวิศวกรรม', 5, '', 0, 5),
(307, 'เครื่องจับกระเเสไฟฟ้า', 5, '', 0, 5),
(308, 'เครื่องทดสอบต้านทานไฟฟ้า(โฮห์ม)', 5, '', 0, 5),
(309, 'ตัวโหลดนำไฟฟ้า', 5, '', 0, 5),
(310, 'ชุดควบคุม LED', 5, '', 0, 5),
(311, 'ปลั๊กรางจ่ายไฟ', 5, '', 0, 5),
(312, 'กล้องถ่ายภาพนิ่ง', 6, '', 0, 5),
(313, 'กล้องถ่ายภาพยนต์', 6, '', 0, 5),
(314, 'เครื่องอัดเเลละขยายภาพ (เครื่องสำเนาเทปโทรทัศน์)', 6, '', 0, 5),
(315, '้เครื่องฉายภาพนิ่ง', 6, '', 0, 5),
(316, 'เครื่องถ่ายทอดสด', 6, '', 0, 5),
(317, 'เครื่องฉายภาพยนตร์', 6, '', 0, 5),
(318, 'จอภาพยนตร์/จอรับภาพ', 6, '', 0, 5),
(319, 'เครื่องเล่น VDO', 6, '', 0, 5),
(320, 'โต๊ะตัดต่อฟิล์มภาพยนตร์', 6, '', 0, 5),
(321, 'เครื่องฉายภาพข้ามศรีษะ', 6, '', 0, 5),
(322, 'เครื่องล้างหัวเทป', 6, '', 0, 5),
(323, 'เลนส์มุมกล้อง', 6, '', 0, 5),
(324, 'เครื่องถ่ายฟิล์ม', 6, '', 0, 5),
(325, 'สไลด์,เครื่องฉายสไลด์', 6, '', 0, 5),
(326, 'เครื่องควบคุมกล้อง', 6, '', 0, 5),
(327, 'เครื่องบันทึกภาพโทรทัศน์ VDO, กล้องถ่าย VDO, กล้องวงจรปิด, กล้องโทรทัศน์', 6, '', 0, 5),
(328, 'โปรเจคเตอร์', 6, '', 0, 5),
(329, 'หูฟัง', 6, '', 0, 5),
(330, 'เครื่องตรวจรรับสัญญาณภาพมอนิเตอร์', 6, '', 0, 5),
(331, 'ขาตั้งกล้อง, ไฟ, โคมไฟ, อุปกรณ์กันสั่น', 6, '', 0, 5),
(332, 'เครื่องตัดฟิล์ม(เครื่องตัด VDO),ชุดสื่อสารมวลชนสำหรับตัดต่อภาพ', 6, '', 0, 5),
(333, 'โทรทัศน์', 6, '', 0, 5),
(334, 'เครื่องทำสำเนา', 6, '', 0, 5),
(335, 'ไฟเเวบ(เเฟล๊ต)', 6, '', 0, 5),
(336, 'เครื่องพิมพ์ภาพสี', 6, '', 0, 5),
(337, 'เตรื่องถ่ายภาพเข้าเครื่องคอมพิวเตอร์', 6, '', 0, 5),
(338, 'ชุดผลิตสื่อนวัตกรรมนอกสถานที่,ชุดสื่อการเรียนการสอน', 6, '', 0, 5),
(339, 'ชุดติดตั้งระบบภาพเเละเสียง', 6, '', 0, 5),
(340, 'กล้องดูดาว,กล้องโทรทัศน์', 7, '', 0, 5),
(341, 'กล้องจุลทรรศน์', 7, '', 0, 5),
(342, 'เครื่องช่วยความสว่างของ-กล้องจุลทัศน์', 7, '', 0, 5),
(343, 'เครื่องดูดควัน/ดูดความชื่น', 7, '', 0, 5),
(344, 'เครื่องดูดอากาศ', 7, '', 0, 5),
(345, 'เครื่องทดสอบความถ่วงจำเพาะของของเหลว', 7, '', 0, 5),
(346, 'เครื่องมือเทียบสีเคมี/สเปคโตโฟมิเตอร์', 7, '', 0, 5),
(347, 'เครื่องลอกลวดลายจากภาพถ่าย', 7, '', 0, 5),
(348, 'เครื่องจ่ายเเก๊สคอลรีน', 7, '', 0, 5),
(349, 'เครื่องเป่าลม/ชุดอนุรักษ์พลังงาน', 7, '', 0, 5),
(350, 'เครื่องตรวจสอบมาตรไฟฟ้า', 7, '', 0, 5),
(351, 'เครื่องมือเติมน้ำยา', 7, '', 0, 5),
(352, 'เครื่องมือทดลองหาลอควิคลิมิท', 7, '', 0, 5),
(353, 'เครื่องมือจับความเร็ว/เครื่องมือวัดความเร็วลม', 7, '', 0, 5),
(354, 'เครื่องวัดกำลังอัด', 7, '', 0, 5),
(355, 'เครื่องวัดความถี่/คลื่นความถี่สูง', 7, '', 0, 5),
(356, 'เครื่องวัดความสูง', 7, '', 0, 5),
(357, 'เครื่องชั่งน้ำหนัก', 7, '', 0, 5),
(358, 'เครื่องอัดลมขับด้วยเครื่องยนต์', 7, '', 0, 5),
(359, 'เครื่องกรองเเสง', 7, '', 0, 5),
(360, 'เครื่องวัดเเสง/วัดคลื่น', 7, '', 0, 5),
(361, 'เครื่องทดสอบเเสงสว่าง', 7, '', 0, 5),
(362, 'เครื่องวัดรังสี/ชุดทดลองการแผ่รังสี', 7, '', 0, 5),
(363, 'เครื่องวัดพลังงานแสงแดด', 7, '', 0, 5),
(364, 'เครื่องวัดความกดอากาศ', 7, '', 0, 5),
(365, 'เครื่องแปลสภาพน้ำกระด้างให้เป็นน้ำอ่อน/เครื่องทำน้ำปราศจากไอออน', 7, '', 0, 5),
(366, 'เครื่องตรวจสอบคุณภาพน้ำ/เครื่องวัดค่าความนำไฟฟ้า', 7, '', 0, 5),
(367, 'เครื่องกลั่นน้ำ', 7, '', 0, 5),
(368, 'เครื่องกลั่นน้ำยา/กลั่นไนโตรเจน', 7, '', 0, 5),
(369, 'เครื่องวัดอุณหภูมิน้ำ/เครื่องวัดอุณหภูมิ', 7, '', 0, 5),
(370, 'เครื่องวัดน้ำฝน', 7, '', 0, 5),
(371, 'เครื่องวัดความเป็นกรด-ด้าง', 7, '', 0, 5),
(372, 'เครื่องระเหยของเหลว', 7, '', 0, 5),
(373, 'เครื่องมือวิเคราะห์ด้วยเปลวไฟ/ชุดวิเคราะห์สารประกอบไนโตรเจน เครื่องมือวิเคราะห์โปรตีน', 7, '', 0, 5),
(374, 'เครื่องวิเคราะแยกขนาดของเม็ดดิน/แยกสารต่างๆ(เครื่องฮิเลคนโตรโพรีซิส)', 7, '', 0, 0),
(375, 'เครื่องวัดความชื้นในดิน', 7, '', 0, 0),
(376, 'เครื่องกวนด้วยแม่เหล็ก', 7, '', 0, 0),
(377, 'เครื่องนึ่ง(หม้อนึ่งอัดไอ)', 7, '', 0, 0),
(378, 'ตู้เก็บเครื่องแก้ววิทยาศาสตร์', 7, '', 0, 0),
(379, 'ตู้ทำน้ำแข็ง', 7, '', 0, 0),
(380, 'หม้อต้มเครื่องมือ,สารเคมี', 7, '', 0, 0),
(381, 'หม้อเก็บอากาศ', 7, '', 0, 0),
(382, 'เตาแอลกอฮอล์', 7, '', 0, 0),
(383, 'โซเดียมแลมพ์', 7, '', 0, 0),
(384, 'เครื่องวัดความยืดและหดตัวของวัตถุ', 7, '', 0, 0),
(385, 'เครื่องขบนิ่ง', 7, '', 0, 0),
(386, 'เครื่องตักตะกอน/ปั่นตะกอน', 7, '', 0, 0),
(387, 'เครื่องวัดตะกอน', 7, '', 0, 0),
(388, 'เครื่องจี้จมูก', 7, '', 0, 0),
(389, 'เครื่องจี้คอ', 7, '', 0, 0),
(390, 'เครื่องเเคะเสมหะ', 7, '', 0, 0),
(391, 'ถังเก็บเชื้อเพลิง', 9, '', 1, 0),
(392, 'เลื่อย', 9, '', 1, 0),
(393, 'เครื่องพิมพ์ลาย', 9, '', 2, 0),
(394, 'แท่นพิมพ์', 9, '', 2, 0),
(395, 'จักรยานออกกำลังกาย', 10, '', 0, 2),
(396, 'เหล็กยกน้ำหนัก', 10, '', 0, 2),
(397, 'บาร์คู่', 10, '', 0, 2),
(398, 'เต็นท์', 11, '', 0, 2),
(399, 'เตียงสนาม', 11, '', 0, 2),
(400, 'ศรีษะโขนละคร', 12, '', 0, 2),
(401, 'เครื่องดนตรีต่างๆ', 12, '', 0, 2),
(402, 'เครื่องคอมพิวเตอร์', 13, '', 0, 3),
(403, 'เครื่องพิมพ์', 13, '', 0, 3),
(404, 'สแกนเนอร์', 13, '', 0, 3),
(405, 'หุ่นจำลอง', 14, '', 0, 2),
(406, 'โต๊ะนักเรียน', 14, '', 0, 2),
(407, 'ปืน', 15, '', 0, 5),
(408, 'ปืนลูกซอง', 15, '', 0, 5),
(409, 'ปืนพก', 15, '', 0, 5),
(410, 'บ้านพักอาศัยชั้นเดียว', 16, '', 0, 15),
(411, 'บ้านพักอาศัยสองชั้น', 16, '', 0, 15),
(412, 'ห้องแถวไม้ทั่วไป', 16, '', 0, 15),
(413, 'ตึกแถวทั่วไป', 16, '', 0, 15),
(414, 'โรงเก็บรถ', 17, '', 0, 8),
(415, 'อาคารเก็บของกลาง', 17, '', 0, 8),
(416, 'อาคารจอดรถ', 17, '', 0, 8),
(417, 'ที่พักชั่วคราว', 17, '', 0, 8),
(418, 'กล้องส่องทางไกล', 18, '', 0, 5),
(419, 'เครื่องเจาะสำรวจ', 18, '', 0, 5),
(420, 'กล้องวัดมุม', 18, '', 0, 5),
(421, 'สระว่ายน้ำ', 19, '', 1, 0),
(422, 'ลานคอนกรีด', 19, '', 1, 0),
(423, 'รั้วลวดหนาม', 19, '', 2, 0),
(424, 'รั่วสังกะสี', 19, '', 2, 0),
(425, 'รั้วไม้', 19, '', 2, 0);
...
CREATE TABLE `sub_types` (
  ...
  `subtypes_name` varchar(200) NOT NULL COMMENT 'ชื่อรายการย่อยของประเภท',
  `subtype_lifetime` int(200) NOT NULL COMMENT 'อายุการใช้งาน',
  `subtypes_type_id` int(10) NOT NULL COMMENT 'ไอดีประเภท'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `tranfer_add`
--

CREATE TABLE `tranfer_add` (
  `tfeq_id` int(200) NOT NULL COMMENT 'หมายเลขครุภัณฑ์',
  `listtf` varchar(200) NOT NULL,
  `amount` int(200) NOT NULL,
  `unit` varchar(200) NOT NULL,
  `note` varchar(200) NOT NULL,
  `transfer_id` int(11) NOT NULL,
  `tranfer_add_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tranfer_add`
--

INSERT INTO `tranfer_add` (`tfeq_id`, `listtf`, `amount`, `unit`, `note`, `transfer_id`, `tranfer_add_id`) VALUES
(1, 'dasdas', 1, 'asdfa', 'asddas', 0, 1),
(1, 'dasdas', 1, 'asdfa', 'asddas', 0, 2),
(1, '1', 1, '1', '1', 0, 3),
(88, 'das', 77, 'หลัง', 'a', 0, 4),
(64564, 'das', 231, 'เครื่อง', 'czxcz', 0, 5),
(655645, 'asdas', 5645, 'เครื่อง', 'zczx', 0, 6),
(999, 'aa', 55, 'เครื่อง', 'zz', 2, 7),
(99, 'zz', 45, 'ตัว', 's', 2, 8),
(64556, 'wqqw', 0, 'ชุด', 'x', 2, 9),
(666, 'q', 1, 'ตัว', 's', 20, 10),
(1221, 'dsa', 0, 'ชุด', 'www', 24, 11),
(0, 'ดเื่่', 0, 'หลัง', 'ดเ้่ืท', 27, 12),
(0, 'เ้ท', 0, 'ชุด', 'ปดเื', 27, 13);

-- --------------------------------------------------------

--
-- Table structure for table `tranfer_eq`
--

CREATE TABLE `tranfer_eq` (
  `tranfer_eq_id` int(11) NOT NULL,
  `te_agency_id` int(11) NOT NULL COMMENT 'รหัสหน่วยงาน',
  `te_number` varchar(200) NOT NULL COMMENT 'หมายเลขครุภัณฑ์',
  `te_sub_id` text NOT NULL COMMENT 'รายการครุภัณฑ์',
  `te_amount` int(11) NOT NULL COMMENT 'จำนวนครุภัณฑ์',
  `te_status_eq_id` varchar(200) NOT NULL COMMENT 'สถานะครุภัณฑ์',
  `te_type_id` varchar(200) NOT NULL COMMENT 'ประเภทครุภัณฑ์',
  `te_date` date NOT NULL COMMENT 'วันที่รับ',
  `te_contract_num` int(200) NOT NULL COMMENT 'เลขที่สัญญา',
  `te_company` int(200) NOT NULL COMMENT 'ผู้ขาย(บริษัท,ห้าง,ร้าน)',
  `te_location` varchar(200) NOT NULL COMMENT 'สถานที่ใช้งาน',
  `te_money_id` varchar(200) NOT NULL COMMENT 'งบที่ใช้',
  `te_price` int(50) NOT NULL COMMENT 'ราคา',
  `te_note` text NOT NULL COMMENT 'หมายเหตุ',
  `te_generation` text NOT NULL COMMENT 'ขนาดและลักษณะ',
  `te_unit_id` varchar(200) NOT NULL COMMENT 'หน่วยนับ',
  `te_branch_id` varchar(200) NOT NULL COMMENT 'สาขา',
  `te_status` int(10) NOT NULL COMMENT 'เก็บสถานะการโอน',
  `te_transfer_id` int(50) NOT NULL COMMENT 'รหัสโอนย้ายครุภัณฑ์'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `transfers` (
  `transfer_id` int(11) NOT NULL COMMENT 'รหัสโอนย้ายครุภัณฑ์ ',
  `tr_document_num` varchar(200) NOT NULL COMMENT 'เลขที่เอกสารการโอน\r\n',
  `tr_agency_old` varchar(200) NOT NULL COMMENT 'หน่วยที่โอน',
  `tr_date` date NOT NULL COMMENT 'วันเดือนปีที่โอนย้าย ',
  `tr_agency_new` int(200) NOT NULL COMMENT 'หน่วยที่รับโอน',
  `tr_location` text NOT NULL COMMENT 'ใช้ประจำ(ที่ใหม่)',
  `tr_note` text NOT NULL COMMENT 'หมายเหตุ',
  `tr_branch_old` varchar(200) NOT NULL COMMENT 'สาขาที่โอน',
  `tr_branch_new` varchar(200) NOT NULL COMMENT 'สาขาที่รับโอน',
  `tr_document_status` varchar(1) NOT NULL COMMENT 'สถานะเอกสาร',
  `tr_approve_status` int(1) NOT NULL COMMENT 'สถานะการอนุมัติ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `transfers` (`transfer_id`, `tr_document_num`, `tr_agency_old`, `tr_date`, `tr_agency_new`, `tr_location`, `tr_note`, `tr_branch_old`, `tr_branch_new`, `tr_document_status`, `tr_approve_status`) VALUES
(30, '1234/65', '52', '2022-05-30', 49, 'อาคาร5', 'fdgasbv', '33', '25', '1', 1),
(31, '77777/552356', '50', '2022-05-25', 52, 'zzz', '5323\r\n85', '37', '34', '1', 1),
(32, '77777/552356', '50', '2022-05-25', 52, 'zzz', '5323\r\n85', '', '', '1', 1),
(33, '', '', '0000-00-00', 0, '', '', '', '', '1', 1),
(34, '', '', '0000-00-00', 0, '', '', '', '', '1', 1);
...
CREATE TABLE `transfer_list` (
  `transfer_list_id` int(11) NOT NULL,
  `tl_number` varchar(200) NOT NULL COMMENT 'หมายเลขครุภัณฑ์',
  `tl_transfer_id` int(200) NOT NULL COMMENT 'รหัสการโอน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `types` (
  `type_id` int(5) NOT NULL COMMENT 'รหัส',
  `type_name` varchar(200) NOT NULL COMMENT 'ประเภทครุภัณฑ์',
  `type_lifetime_low` int(2) DEFAULT NULL COMMENT 'อายุการใช้งานต่ำสุด',
  `type_lifetime_max` int(11) NOT NULL COMMENT 'อายุการใช้งานสูงสุด',
  `type_depreciation` float NOT NULL COMMENT 'อัตราค่าเสื่อมราต่อปีเปอร์เซนต์'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `types` (`type_id`, `type_name`, `type_lifetime_low`, `type_lifetime_max`, `type_depreciation`) VALUES
(1, 'ครุภัณฑ์สำนักงาน', 3, 12, 12.5),
(2, 'ครุภัณฑ์ยานพาหนะเเละขนส่ง', 5, 30, 20),
(5, 'ครุภัณฑ์ไฟฟ้าเเละวิทยุ', 5, 10, 20),
(6, 'ครุภัณฑ์โฆษณาเเละการเผยเเพร่', 5, 10, 20),
(7, 'ครุภัณฑ์วิทยาศาสตร์เเละการเเพทย์', 5, 15, 20),
(8, 'ครุภัณฑ์งานบ้านเเละงานครัว', 2, 5, 33.33),
(10, 'ครุภัณฑ์กีฬา', 2, 5, 33.33),
(11, 'ครุภัณฑ์สนาม,สำรวจ', 2, 5, 33.33),
(12, 'ครุภัณฑ์ดนตรีเเละนาฎศิลป์', 2, 5, 33.33),
(13, 'ครุภัณฑ์คอมพิวเตอร์', 3, 5, 33.33),
(14, 'ครุภัณฑ์การศึกษา', 2, 5, 33.33),
(15, 'ครุภัณฑ์อาวุธ\r\n', 5, 10, 10),
(16, 'อาคารถาวร', 15, 40, 3.33),
(17, 'อาคารชั่วคราว/โรงเรือน', 8, 15, 10),
(18, 'ครุภัณฑ์สำรวจ', 5, 10, 12.5);
...
CREATE TABLE `units` (
  ...
  `unit_name` varchar(200) NOT NULL COMMENT 'หน่วยนับ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `userlevels` (
  ...
  `userlevel_name` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `users` (
  ...
  `user_title_id` varchar(200) NOT NULL COMMENT 'คำนำหน้าชื่อ',
  `user_fname` varchar(200) NOT NULL COMMENT 'ชื่อจริง',
  `user_lname` varchar(11) NOT NULL COMMENT 'นามสกุล',
  `user_gender` varchar(200) NOT NULL COMMENT 'เพศ',
  `user_idcard` int(13) NOT NULL COMMENT 'เลขรหัสประจำตัวประชาชน',
  `user_birthday` date NOT NULL COMMENT 'วันเกิด',
  `user_address` varchar(200) NOT NULL COMMENT 'ที่อยู่',
  `user_provinces` varchar(200) NOT NULL COMMENT 'ที่อยู่(จังหวัด)',
  `user_amphures` varchar(200) NOT NULL COMMENT 'ที่อยู่(อำเภอ)',
  `user_districts` varchar(200) NOT NULL COMMENT 'ที่อยู่(ตำบล)',
  `user_tel` varchar(10) NOT NULL COMMENT 'หมายเลขโทรศัพท์',
  `user_email` varchar(50) NOT NULL COMMENT 'อีเมล',
  `user_username` varchar(50) NOT NULL COMMENT 'ชื่อเข้าใช้งาน',
  `user_pass` varchar(50) NOT NULL COMMENT 'รหัสเข้าใช้งาน',
  `user_userlevel_id` varchar(200) NOT NULL COMMENT 'สถานะผู้ใช้งาน',
  `user_zip_code` varchar(200) NOT NULL COMMENT 'ไปรษณีย์',
...
INSERT INTO `users` (`user_id`, `user_title_id`, `user_fname`, `user_lname`, `user_gender`, `user_idcard`, `user_birthday`, `user_address`, `user_provinces`, `user_amphures`, `user_districts`, `user_tel`, `user_email`, `user_username`, `user_pass`, `user_userlevel_id`, `user_zip_code`, `user_image`) VALUES
(83, 'ดร.', 'ฟางงงง22', 'ยสดวส', '2', 2147483647, '2022-04-20', 'แ้ิกดอแหผเะหำกเ', '16', '199', '251107', '0232123123', 'fang@gamil.com', '1234', '81dc9bdb52d04dc20036dbd8313ed055', 'เจ้าหน้าที่', '   0', '99.webp'),
(84, 'ผศ.ดร.', 'ฟางงงง22', 'ยสดวส', 'หญิง', 2147483647, '2022-04-02', '่ดเ้่ดเ', '17', '204', '260303', '22222222', 'fang02554@gamil.com', '0123', '2c71e977eccffb1cfb7c6cc22e0e7595', 'เจ้าหน้าที่', '   26110', '63.jpg'),
(85, 'ดร.', 'ฟางงงง22', 'ยสดวส', '2', 2147483647, '2022-04-20', 'แ้ิกดอแหผเะหำกเ', '16', '199', '251107', '0232123123', 'fang@gamil.com', '0123', '2c71e977eccffb1cfb7c6cc22e0e7595', 'เจ้าหน้าที่', '   0', '99.webp'),
(86, '', 'llll', 'kkkkk', '', 2147483647, '2022-06-03', 'hkyuu', '17', '202', '260110', 'kkkkkk', 'afkds144@khidaeng.com', '', '2c71e977eccffb1cfb7c6cc22e0e7595', '', '', ''),
(87, 'นางสาว', 'llll', 'kkkkk', '', 2147483647, '2022-06-03', 'hkyuu', '17', '202', '260110', 'kkkkkk', 'afkds144@khidaeng.com', '0123', '2c71e977eccffb1cfb7c6cc22e0e7595', '', '26000', ''),
(88, 'นางสาว', 'llll', 'kkkkk', '', 2147483647, '2022-06-03', 'hkyuu', '17', '202', '260110', 'kkkkkk', 'afkds144@khidaeng.com', '0123', 'eb62f6b9306db575c2d596b1279627a4', 'เจ้าหน้าที่', '26000', ''),
(89, 'นางสาว', 'พิมพ์ลภัส', 'ยอดไฟอินทร์', '', 2147483647, '2022-07-07', '21 ม1', '20', '271', '312203', '0630035645', 'yod@gmail.com', '2233333', 'a34b77a4eb16a933a00af05bcf464660', 'เจ้าหน้าที่', '31150', '');
...
--
-- Indexes for table `disbursements_eq`
--
ALTER TABLE `disbursements_eq`
  ADD PRIMARY KEY (`disbursement_eq_id`);
...
--
-- Indexes for table `tranfer_add`
--
ALTER TABLE `tranfer_add`
  ADD PRIMARY KEY (`tranfer_add_id`);

--
-- Indexes for table `tranfer_eq`
--
ALTER TABLE `tranfer_eq`
  ADD PRIMARY KEY (`tranfer_eq_id`);
...
ALTER TABLE `transfer_list`
  ADD PRIMARY KEY (`transfer_list_id`);
...
--
ALTER TABLE `agencys`
  MODIFY `agency_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสประเภทหน่วยงาน	', AUTO_INCREMENT=54;

--
-- AUTO_INCREMENT for table `branchs`
--
ALTER TABLE `branchs`
  MODIFY `branch_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'field of study', AUTO_INCREMENT=54;
...
--
-- AUTO_INCREMENT for table `disbursements_eq`
--
ALTER TABLE `disbursements_eq`
  MODIFY `disbursement_eq_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสเบิกจ่ายครุภัณฑ์', AUTO_INCREMENT=34;
...
--
ALTER TABLE `moneys`
  MODIFY `money_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `subcategorys`
  MODIFY `sub_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=426;

--
-- AUTO_INCREMENT for table `sub_types`
--
ALTER TABLE `sub_types`
  MODIFY `subtypes_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tranfer_add`
--
ALTER TABLE `tranfer_add`
  MODIFY `tranfer_add_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tranfer_eq`
--
ALTER TABLE `tranfer_eq`
  MODIFY `tranfer_eq_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `transfers`
--
ALTER TABLE `transfers`
  MODIFY `transfer_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสโอนย้ายครุภัณฑ์ ', AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `transfer_list`
--
ALTER TABLE `transfer_list`
  MODIFY `transfer_list_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `types`
--
ALTER TABLE `types`
  MODIFY `type_id` int(5) NOT NULL AUTO_INCREMENT COMMENT 'รหัส', AUTO_INCREMENT=21;
...
--
ALTER TABLE `users`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสบุคลากร', AUTO_INCREMENT=90;
COMMIT;
